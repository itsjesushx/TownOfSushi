...
public abstract class TownOfSushiButton : CustomActionButton
{
    ...
    public override void CreateButton(Transform parent)
    {
        ...
        Button.usesRemainingSprite.sprite = TownOfSushiAssets.AbilityCounterBasicSprite.LoadAsset();
    ...
    public override void CreateButton(Transform parent)
    {
        ...
        switch (typeof(T))
        {
            case Type t when t == typeof(Vent):
                Button.usesRemainingSprite.sprite = TownOfSushiAssets.AbilityCounterVentSprite.LoadAsset();
                break;
            ...
            case Type t when t == typeof(PlayerControl):
                Button.usesRemainingSprite.sprite = TownOfSushiAssets.AbilityCounterPlayerSprite.LoadAsset();
                break;
            default:
                Button.usesRemainingSprite.sprite = TownOfSushiAssets.AbilityCounterBasicSprite.LoadAsset();
                break;
