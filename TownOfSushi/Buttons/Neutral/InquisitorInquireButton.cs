...
public sealed class InquisitorInquireButton : TownOfSushiRoleButton<InquisitorRole, PlayerControl>
{
    ...
    protected override void OnClick()
    {
        ...
        var notif1 = Helpers.CreateAndShowNotification(
            $"<b>{TownOfSushiColors.Inquisitor.ToTextColor()}You will know if {Target.Data.PlayerName} is a heretic during the next meeting.</color></b>", Color.white, spr: TosRoleIcons.Inquisitor.LoadAsset());
