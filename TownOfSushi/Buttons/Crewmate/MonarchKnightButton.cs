...
public sealed class KnightButton : TownOfSushiRoleButton<MonarchRole, PlayerControl>
{
    ...
    protected override void OnClick()
    {
        ...
        Usable = false;
        var notif1 = Helpers.CreateAndShowNotification($"<b>{TownOfSushiColors.Monarch.ToTextColor()}You have knighted{Target.Data.PlayerName}, they will have an extra vote each meeting as long as you're alive.</color></b>", Color.white, new Vector3(0f, 1f, -20f), spr: TOSCrewAssets.KnightSprite.LoadAsset());
