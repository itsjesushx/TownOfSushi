...
public sealed class CampButton : TownOfSushiRoleButton<DeputyRole, PlayerControl>
{
    ...
    protected override void OnClick()
    {
        ...
        Usable = false;  
        var notif1 = Helpers.CreateAndShowNotification($"<b>Wait for {Target.Data.PlayerName}'s death so you can avenge them in the meeting.</b>", Color.white, new Vector3(0f, 1f, -20f), spr: TosRoleIcons.Deputy.LoadAsset());
