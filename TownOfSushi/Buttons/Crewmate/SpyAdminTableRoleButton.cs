...
public sealed class SpyAdminTableRoleButton : TownOfSushiButton
{
    ...
    public override bool Enabled(RoleBehaviour? role)
    {
        return PlayerControl.LocalPlayer != null &&
               PlayerControl.LocalPlayer.HasModifier<SpyModifier>() && OptionGroupSingleton<SpyOptions>.Instance.HasPortableAdmin;
    }
