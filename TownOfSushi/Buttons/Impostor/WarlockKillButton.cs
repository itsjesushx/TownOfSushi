...
public sealed class WarlockKillButton : TownOfSushiRoleButton<WarlockRole, PlayerControl>, IDiseaseableButton, IKillButton
{
    ...
    public override PlayerControl? GetTarget()
    {
        ...
        var includePostors = genOpt.FFAImpostorMode ||
            ...
            (genOpt.KillDuringCamoComms && closePlayer?.GetAppearanceType() == TownOfSushiAppearances.Camouflage);
