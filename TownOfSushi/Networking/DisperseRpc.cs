...
[RegisterCustomRpc((uint)TownOfSushiRpc.Disperse)]
public sealed class DisperseRpc(TownOfSushiPlugin plugin, uint id) : PlayerCustomRpc<TownOfSushiPlugin, Dictionary<byte, Vector2>>(plugin, id)
{
