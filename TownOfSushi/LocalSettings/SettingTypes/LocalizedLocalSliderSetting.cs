...
namespace TownOfSushi.LocalSettings.SettingTypes;
...
public class LocalizedLocalSliderSetting : LocalSliderSetting
{
    ...
    protected override string GetValueText()
    {
        if (DisplayValue)
        {
            ...
            return $"<font=\"LiberationSans SDF\" material=\"LiberationSans SDF - Chat Message Masked\">{LocaleKey}: <b>{formated} / {maxFormated}</font></b>";
        }

        return $"<font=\"LiberationSans SDF\" material=\"LiberationSans SDF - Chat Message Masked\">{LocaleKey}</font></b>";
    }
    /// <inheritdoc/>
    public static string GetLocalizedValueText(LocalizedLocalSliderSetting slider, string localeName)
    {
        if (slider.DisplayValue)
        {
            ...
            return $"<font=\"LiberationSans SDF\" material=\"LiberationSans SDF - Chat Message Masked\">{localeName}: <b>{formated} / {maxFormated}</font></b>";
        }

        return $"<font=\"LiberationSans SDF\" material=\"LiberationSans SDF - Chat Message Masked\">{localeName}</font></b>";
    }
}
