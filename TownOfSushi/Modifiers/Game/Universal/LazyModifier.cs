...
public sealed class LazyModifier : UniversalGameModifier, IWikiDiscoverable
{
    ...
    {
        return (int)OptionGroupSingleton<UniversalModifierOptions>.Instance.LazyChance;
    }

    public override int GetAmountPerGame()
    {
        return (int)OptionGroupSingleton<UniversalModifierOptions>.Instance.LazyAmount;
    }
