...
public sealed class ParanoiacModifier : UniversalGameModifier, IWikiDiscoverable
{
    ...
    public override LoadableAsset<Sprite>? ModifierIcon => TownOfSushiAssets.Paranoiac;
    ...
    {
        _arrow = Utils.CreateArrow(Player.gameObject.transform, new Color(1f, 0f, 0.5f, 1f));
    }
