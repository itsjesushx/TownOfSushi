...
public sealed class ShyModifier : UniversalGameModifier, IWikiDiscoverable
{
    ...
    public override LoadableAsset<Sprite>? ModifierIcon => TownOfSushiAssets.Shy;
    ...
    public override void Update()
    {
        ...
        else if (Player.GetAppearanceType() == TownOfSushiAppearances.Camouflage || Player.GetAppearanceType() == TownOfSushiAppearances.Paint)
        {
