...
public sealed class SatelliteButton : TownOfSushiButton
{
    ...
    public override float Cooldown => OptionGroupSingleton<SatelliteOptions>.Instance.Cooldown;
    public override int MaxUses => (int)OptionGroupSingleton<SatelliteOptions>.Instance.MaxNumCast;
    public override ButtonLocation Location => ButtonLocation.BottomLeft;
    public override LoadableAsset<Sprite> Sprite => TownOfSushiAssets.BroadcastSprite;
    ...
    public override void CreateButton(Transform parent)
    {
        ...
        Button!.usesRemainingSprite.sprite = TownOfSushiAssets.AbilityCounterBodySprite.LoadAsset();
    }
    ...
    protected override void OnClick()
    {
        ...
        if (deadBodies.Count == 0)
        {
            var notif1 = Helpers.CreateAndShowNotification("<b>No bodies were found on the map.</b>", Color.white,
                new Vector3(0f, 1f, -20f), spr: TownOfSushiAssets.Satellite.LoadAsset());
        ...
        //deadBodies.Do(x => PlayerControl.LocalPlayer.GetModifier<SatelliteModifier>().NewMapIcon(Utils.PlayerById(x.ParentId)));
    }
}