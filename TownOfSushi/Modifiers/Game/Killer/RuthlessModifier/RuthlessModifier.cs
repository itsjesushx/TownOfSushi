...
public sealed class RuthlessModifier : TOSGameModifier, IWikiDiscoverable
{
    ...
    public override LoadableAsset<Sprite>? ModifierIcon => TownOfSushiAssets.Saboteur;
    ...
    public override bool IsModifierValidOn(RoleBehaviour role)
    {
        ...
        || role.Player.Data.Role is JesterRole && OptionGroupSingleton<JesterOptions>.Instance.JesterCanKill);
    }
}