...
public sealed class UnderdogModifier : TOSGameModifier, IWikiDiscoverable
{
    ...
    public override LoadableAsset<Sprite>? ModifierIcon => TownOfSushiAssets.Underdog;
    ...
    {
        return (int)OptionGroupSingleton<UnderdogOptions>.Instance.UnderdogChance;
    }

    public override int GetAmountPerGame()
    {
        return (int)OptionGroupSingleton<UnderdogOptions>.Instance.UnderdogAmount;
    }
