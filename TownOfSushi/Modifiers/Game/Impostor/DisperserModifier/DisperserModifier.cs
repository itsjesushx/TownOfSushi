...
public sealed class DisperserModifier : TOSGameModifier, IWikiDiscoverable
{
    ...
    public override LoadableAsset<Sprite>? ModifierIcon => TownOfSushiAssets.Disperser;
    ...
    [
        new("Disperse",
            ...
            TownOfSushiAssets.DisperseSprite)
    ];
    ...
    public static IEnumerator CoDisperse(Dictionary<byte, Vector2> coordinates)
    {
        ...
        var notif1 = Helpers.CreateAndShowNotification(
            Utils.ColorString(TownOfSushiColors.ImpSoft, $"<b>Everyone has been dispersed to a vent!</b>"), Color.white,
            spr: TownOfSushiAssets.Disperser.LoadAsset());
