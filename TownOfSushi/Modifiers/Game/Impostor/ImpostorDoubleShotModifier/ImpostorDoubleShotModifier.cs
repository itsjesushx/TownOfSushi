...
public sealed class ImpostorDoubleShotModifier : DoubleShotModifier, IWikiDiscoverable
{
    ...
    {
        return (int)OptionGroupSingleton<ImpostorDoubleShotOptions>.Instance.ImpostorDoubleShotChance;
    }

    public override int GetAmountPerGame()
    {
        return (int)OptionGroupSingleton<ImpostorDoubleShotOptions>.Instance.ImpostorDoubleShotAmount;
    }
