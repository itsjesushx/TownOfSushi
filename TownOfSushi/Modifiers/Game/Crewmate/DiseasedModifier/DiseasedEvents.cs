    ...
    public static void AfterMurderEventHandler(AfterMurderEvent @event)
    {
        ...
        if (source.AmOwner)
        {
            var notif1 = Helpers.CreateAndShowNotification(
                Utils.ColorString(TownOfSushiColors.Diseased, $"<b>{@event.Target.Data.PlayerName} was Diseased, causing your kill cooldown to multiply by {Math.Round(cdMultiplier, 2)}.</b>"),
                Color.white, spr: TownOfSushiAssets.Diseased.LoadAsset());
