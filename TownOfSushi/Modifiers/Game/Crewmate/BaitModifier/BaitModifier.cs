...
public sealed class BaitModifier : TOSGameModifier, IWikiDiscoverable
{
    ...
    public override string IntroInfo => "You will force your killer to report your body.";
    public override LoadableAsset<Sprite>? ModifierIcon => TownOfSushiAssets.Bait;
    ...
    public static IEnumerator CoReportDelay(PlayerControl killer, PlayerControl target)
    {
        ...
        if (killer.AmOwner)
        {
            ...
            var notif1 = Helpers.CreateAndShowNotification(
                Utils.ColorString(TownOfSushiColors.Bait, $"<b>{target.Data.PlayerName} was a Bait, causing you to self report.</b>"),
                Color.white, spr: TownOfSushiAssets.Bait.LoadAsset());
