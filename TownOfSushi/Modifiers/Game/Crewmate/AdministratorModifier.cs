...
public sealed class AdministratorModifier : TOSGameModifier, IWikiDiscoverable
{
    ...
    {
        return (int)OptionGroupSingleton<CrewmateModifierOptions>.Instance.AdministratorChance;
    }

    public override int GetAmountPerGame()
    {
        return (int)OptionGroupSingleton<CrewmateModifierOptions>.Instance.AdministratorAmount;
    }
