...
public static class CelebrityEvents
{
    ...
    public static void AfterMurderEventHandler(AfterMurderEvent @event)
    {
        ...
        if (target.HasModifier<CelebrityModifier>())
        {
            ...
            Coroutines.Start(Utils.CoFlash(TownOfSushiColors.Celebrity, PlaySound: true));

            var notif1 = Helpers.CreateAndShowNotification(
            Utils.ColorString(TownOfSushiColors.Celebrity, $"<b>The Celebrity, {celeb.Player.Data.PlayerName}, has been killed! Everyone will get info at the start of the meeting</b>"), Color.white,
            new Vector3(0f, 1f, -20f), spr: TownOfSushiAssets.Celebrity.LoadAsset());
