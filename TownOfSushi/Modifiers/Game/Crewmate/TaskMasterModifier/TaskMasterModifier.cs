...
public sealed class TaskmasterModifier : TOSGameModifier, IWikiDiscoverable
{
    ...
    public override LoadableAsset<Sprite>? ModifierIcon => TownOfSushiAssets.Taskmaster;
        ...
        if (Player.AmOwner && Player.myTasks.Count > 0 && !Player.HasDied())
        {
            ...
            if (tasks.Count > 0)
            {
                ...
                var notif1 = Helpers.CreateAndShowNotification(
                    Utils.ColorString(TownOfSushiColors.Taskmaster, $"<b>The task '{taskText}' has been completed for you.</b>"),
                    Color.white, spr: TownOfSushiAssets.Taskmaster.LoadAsset());
