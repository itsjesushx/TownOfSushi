...
public sealed class AdministratorAdminTableModifierButton : TownOfSushiButton
{
    ...
    public override float Cooldown => OptionGroupSingleton<AdministratorOptions>.Instance.DisplayCooldown;
    ...
    public override LoadableAsset<Sprite> Sprite => TownOfSushiAssets.AdminSprite;
