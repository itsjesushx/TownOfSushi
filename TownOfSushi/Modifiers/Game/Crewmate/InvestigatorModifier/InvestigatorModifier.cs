...
public sealed class InvestigatorModifier : TOSGameModifier, IWikiDiscoverable
{
    ...
    public override LoadableAsset<Sprite>? ModifierIcon => TownOfSushiAssets.Investigator;
    ...
    {
        return (int)OptionGroupSingleton<InvestigatorOptions>.Instance.InvestigatorChance;
    }

    public override int GetAmountPerGame()
    {
        return (int)OptionGroupSingleton<InvestigatorOptions>.Instance.InvestigatorAmount;
    }
