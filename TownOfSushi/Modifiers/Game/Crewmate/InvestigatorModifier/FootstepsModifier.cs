...
public sealed class FootstepsModifier : BaseModifier
{
    ...
    public static int FootstepColor = 6;
    ...
    public override void FixedUpdate()
    {
        ...
        sprite.sprite = TownOfSushiAssets.FootprintSprite.LoadAsset();
        sprite.color = AnonymousPrints
            ? new Color(0.2f, 0.2f, 0.2f, 1f) : Player.cosmetics.currentBodySprite.BodySprite.material.GetColor(ShaderID.BodyColor);
    ...
    {
        yield return Utils.FadeOut(rend, 0.0001f, 0.05f);
