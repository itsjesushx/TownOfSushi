...
public sealed class NoisemakerModifier : TOSGameModifier, IWikiDiscoverable
{
    ...
    public override LoadableAsset<Sprite>? ModifierIcon => TownOfSushiAssets.Noisemaker;
    ...
    {
        return (int)OptionGroupSingleton<NoisemakerOptions>.Instance.NoisemakerChance;
    }

    public override int GetAmountPerGame()
    {
        return (int)OptionGroupSingleton<NoisemakerOptions>.Instance.NoisemakerAmount;
    }
    ...
    public void NotifyOfDeath(PlayerControl player)
    {
        ...
        {
            var audio = SoundManager.Instance.PlaySound(TownOfSushiAudio.NoisemakerDeathSound.LoadAsset(), false, 1,
