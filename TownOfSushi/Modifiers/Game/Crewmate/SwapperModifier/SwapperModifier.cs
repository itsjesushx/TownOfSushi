...
public sealed class SwapperModifier : TOSGameModifier, IWikiDiscoverable
{
    ...
    public override LoadableAsset<Sprite>? ModifierIcon => TownOfSushiAssets.Swapper;
    ...
    public override void OnActivate()
    {
        ...
        if (Player.AmOwner)
        {
            meetingMenu = new MeetingMenu(Player.Data.Role, SetActive, MeetingAbilityType.Toggle, TownOfSushiAssets.SwapActive,
                TownOfSushiAssets.SwapInactive, IsExempt)
            {
    ...
    {
        return base.IsModifierValidOn(role) && role.IsCrewmate() && role is not SheriffRole;
    }
