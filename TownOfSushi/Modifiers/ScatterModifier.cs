...
public class ScatterModifier(float time) : TimedModifier
{
    ...
    public override void OnActivate()
    {
        ...
        //Logger<TownOfSushiPlugin>.Error($"ScatterModifier.OnActivate");
        ...
        scatterUI = Object.Instantiate(TOSAssets.ScatterUI.LoadAsset(), HudManager.Instance.transform);
    ...
    public override void FixedUpdate()
    {
        ...
        //Logger<TownOfSushiPlugin>.Error($"Scatter - !Player.AmOwner: {!Player.AmOwner} !TimerActive: {!TimerActive} Player.HasDied(): {Player.HasDied()} MeetingHud.Instance: {MeetingHud.Instance} ScatterEvents.Intro: {ScatterEvents.Intro}");
    ...
    {
        //Logger<TownOfSushiPlugin>.Error($"Scatter - OnRoundStart");
