...
namespace TownOfSushi
{
    public static class SubmergedCompatibility
    {
        ...
        public static bool TryLoadSubmerged()
        {
            try
            {
                TownOfSushiPlugin.Logger.LogMessage("Trying to load Submerged...");
            ...
            {
                TownOfSushiPlugin.Logger.LogError(e);
            }
            return false;
        }
        ...
        public static void RepairOxygen() {
            ...
            try {
                ...
                TownOfSushiPlugin.Logger.LogMessage("null reference in engineer oxygen fix");
            }
