...
namespace TownOfSushi.Objects {
    class Garlic {
        ...
        public static Sprite getGarlicSprite() {
            ...
            garlicSprite = Helpers.LoadSpriteFromResources("TownOfSushi.Resources.Garlic.png", 300f);
            return garlicSprite;
        }
        ...
        public static Sprite getBackgroundSprite() {
            ...
            backgroundSprite = Helpers.LoadSpriteFromResources("TownOfSushi.Resources.GarlicBackground.png", 60f);
