    ...
    public class Portal 
    {
        ...
        public static Sprite GetFgAnimationSprite(int index) 
        {
            ...
            if (portalFgAnimationSprites[index] == null)
                portalFgAnimationSprites[index] = (Utils.LoadSprite($"TownOfSushi.Resources.PortalAnimation.portal_{(index):000}.png", 115f));
        ...
        private static void PreloadSprites() 
        {
            ...
            portalSprite = Utils.LoadSprite("TownOfSushi.Resources.PortalAnimation.plattform.png", 115f);
        }
