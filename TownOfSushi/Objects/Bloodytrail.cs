...
namespace TownOfSushi.Objects 
{
    class Bloodytrail 
    {
        ...
        public static List<Sprite> GetBloodySprites() 
        {
            ...
            sprites.Add(Helpers.LoadSpriteFromResources("TownOfSushi.Resources.Blood1.png", 700));
            sprites.Add(Helpers.LoadSpriteFromResources("TownOfSushi.Resources.Blood2.png", 500));
            sprites.Add(Helpers.LoadSpriteFromResources("TownOfSushi.Resources.Blood3.png", 300));
            return sprites;
        }
