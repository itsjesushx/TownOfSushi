...
public class BepInExUpdater : MonoBehaviour
{
    ...
    public void Awake()
    {
        TownOfSushiPlugin.Logger.LogMessage("BepInEx Update Required...");
        TownOfSushiPlugin.Logger.LogMessage($"{Paths.BepInExVersion}, {RequiredBepInExVersion} ");
    ...
    {
        Task.Run(() => MessageBox(GetForegroundWindow(), "Required BepInEx update is downloading, please wait...","Town Of Sushi", 0));
