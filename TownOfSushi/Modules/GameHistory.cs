...
public static class GameHistory
{
    ...
    {
        //Logger<TownOfSushiPlugin>.Message($"RegisterRole - player: '{player.Data.PlayerName}', role: '{role.NiceName}'");
