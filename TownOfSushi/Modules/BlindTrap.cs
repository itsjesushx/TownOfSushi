...
namespace TownOfSushi.Modules
{
    class BlindTrap
    {
        ...
        public BlindTrap(Vector2 p)
        {
            ...
            trap.AddSubmergedComponent(ModCompatibility.Classes.ElevatorMover);
            ...
            if (PlayerControl.LocalPlayer.Data.Role is PoisonerRole || PlayerControl.LocalPlayer.Data.IsDead)
            {
                trap.SetActive(true);
                SetAlpha(0.5f);
            }
        ...
        public static void TriggerTrap(byte playerId, byte trapId)
        {
            ...
            if (player.GetRoleWhenAlive() is PoisonerRole poisoner) return;
            ...
            else if (PlayerControl.LocalPlayer.Data.Role is PoisonerRole)
            {
                t.trap.SetActive(true);
                t.SetAlpha(0.5f);
            }
