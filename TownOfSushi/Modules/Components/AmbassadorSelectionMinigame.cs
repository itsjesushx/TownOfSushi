...
public sealed class AmbassadorSelectionMinigame(IntPtr cppPtr) : Minigame(cppPtr)
{
    ...
    private void Awake()
    {
        ...
        RoleIcon.sprite = TOSRoleIcons.RandomImp.LoadAsset();
    ...
    {
        var gameObject = Instantiate(TOSAssets.AltRoleSelectionGame.LoadAsset(), HudManager.Instance.transform);
    ...
    private void Begin()
    {
        ...
        var randomCard = CreateCard("Random", "Random Impostor", TOSRoleIcons.RandomImp.LoadAsset(),
            TownOfSushiColors.Impostor);
    ...
    private PassiveButton CreateCard(string roleName, string teamName, Sprite? sprite, Color color)
    {
        ...
        roleImage.sprite = (sprite != null) ? sprite : TOSRoleIcons.RandomImp.LoadAsset();
