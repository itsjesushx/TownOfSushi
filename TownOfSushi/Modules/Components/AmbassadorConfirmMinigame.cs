...
public sealed class AmbassadorConfirmMinigame(IntPtr cppPtr) : Minigame(cppPtr)
{
    ...
    private void Awake()
    {
        ...
        RoleIcon.sprite = NewRole.RoleIconWhite ?? TOSRoleIcons.RandomImp.LoadAsset();
    ...
    {
        var gameObject = Instantiate(TOSAssets.ConfirmMinigame.LoadAsset(), HudManager.Instance.transform);
