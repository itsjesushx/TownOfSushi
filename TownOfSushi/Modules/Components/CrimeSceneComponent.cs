...
public sealed class CrimeSceneComponent(nint cppPtr) : MonoBehaviour(cppPtr)
{
    ...
    public void Awake()
    {
        ...
        render.sprite = TownOfSushiAssets.CrimeSceneSprite.LoadAsset();
    ...
    public void FixedUpdate()
    {
        ...
        foreach (var player in PlayerControl.AllPlayerControls)
        {
            ...
            // Debug.Log(GetComponent<BoxCollider2D>().IsTOSching(player.Collider));
    ...
    {
        var crimeScene = _crimeScenes.FirstOrDefault(x => x.DeadPlayer == Utils.PlayerById(body.ParentId));
