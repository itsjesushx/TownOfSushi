...
namespace TownOfSushi.Modules 
{
    public class CustomColors 
    {
        ...
        private static readonly List<int> ORDER = new List<int>() { 7, 37, 14, 5, 33, 41, 25,
                                                                    4, 30, 0, 42, 35, 3, 27, 17,
                                                                    13, 23, 8, 32, 38, 1, 21,
                                                                    40, 31, 10, 34, 22, 28, 36,
                                                                    2, 11, 26, 29, 20, 19, 18,
                                                                    12, 9, 24, 16, 15, 6, 39, 43
                                                                    };
        public static void Load() 
        {
            ...
            colors.Add(new CustomColor { longname = "Cherry", // 42
                                        color = new Color32(222, 55, 55, byte.MaxValue),
                                        shadow = new Color32(186, 45, 45, byte.MaxValue),
                                        isLighterColor = false
            });
            colors.Add(new CustomColor { longname = "Void", // 43
        ...
        public static class CustomColorPatches {
            ...
            private class ChatNotificationColorsPatch 
            {
                ...
                {
                    if (ShipStatus.Instance && !TownOfSushi.ShowChatNotifications.Value)
                    {
                        return false;
                    }
