...
namespace TownOfSushi 
{
    public class CustomOption 
    {
        ...
        public static void SwitchPreset(int newPreset) 
        {
            ...
            vanillaSettings = TownOfSushiPlugin.Instance.Config.Bind($"Preset{preset}", "GameOptions", "");
            LoadVanillaOptions();
            foreach (CustomOption option in options) 
            {
                if (option.id == 0) continue;

                option.entry = TownOfSushiPlugin.Instance.Config.Bind($"Preset{preset}", option.id.ToString(), option.defaultSelection);
        ...
        public static bool LoadVanillaOptions() 
        {
            ...
            if (gameOptions.Version < 8) {
                TownOfSushiPlugin.Logger.LogMessage("tried to paste old settings, not doing this!");
                return false;
            } 
        ...
        public static int pasteFromClipboard() {
            ...
            try {
                ...
                if (TownOfSushiPlugin.Version > versionInfo && versionInfo < Version.Parse("4.6.0")) {
                    ...
                    FastDestroyableSingleton<HudManager>.Instance.Chat.AddChat(PlayerControl.LocalPlayer, "Host Info: Pasting vanilla settings failed, TOS Options applied!");
                } else {
    ...
    class GameOptionsMenuStartPatch 
    {
        ...
        public static void Postfix(GameSettingMenu __instance) 
        {
            ...
            bgrenderer.sprite = Helpers.LoadSpriteFromResources("TownOfSushi.Resources.CopyPasteBG.png", 175f);
            ...
            copyButtonRenderer.sprite = Helpers.LoadSpriteFromResources("TownOfSushi.Resources.Copy.png", 100f);
            ...
            pasteButtonRenderer.sprite = Helpers.LoadSpriteFromResources("TownOfSushi.Resources.Paste.png", 100f);
    ...
    class GameOptionsDataPatch
    {
        ...
        public static string buildAllOptions(string vanillaSettings = "", bool hideExtras = false) {
            ...
            int counter = TownOfSushiPlugin.optionsPage;
    ...
    public static class GameOptionsNextPagePatch
    {
        ...
        {
            int page = TownOfSushiPlugin.optionsPage;
            if (Input.GetKeyDown(KeyCode.Tab)) 
            {
                TownOfSushiPlugin.optionsPage = (TownOfSushiPlugin.optionsPage + 1) % 8;
            }
            if (Input.GetKeyDown(KeyCode.Alpha1) || Input.GetKeyDown(KeyCode.Keypad1)) 
            {
                TownOfSushiPlugin.optionsPage = 0;
            }
            if (Input.GetKeyDown(KeyCode.Alpha2) || Input.GetKeyDown(KeyCode.Keypad2)) 
            {
                TownOfSushiPlugin.optionsPage = 1;
            }
            if (Input.GetKeyDown(KeyCode.Alpha3) || Input.GetKeyDown(KeyCode.Keypad3)) 
            {
                TownOfSushiPlugin.optionsPage = 2;
            }
            if (Input.GetKeyDown(KeyCode.Alpha4) || Input.GetKeyDown(KeyCode.Keypad4)) 
            {
                TownOfSushiPlugin.optionsPage = 3;
            }
            if (Input.GetKeyDown(KeyCode.Alpha5) || Input.GetKeyDown(KeyCode.Keypad5)) 
            {
                TownOfSushiPlugin.optionsPage = 4;
            }
            if (Input.GetKeyDown(KeyCode.Alpha6) || Input.GetKeyDown(KeyCode.Keypad6)) 
            {
                TownOfSushiPlugin.optionsPage = 5;
            }
            if (Input.GetKeyDown(KeyCode.Alpha7) || Input.GetKeyDown(KeyCode.Keypad7)) 
            {
                TownOfSushiPlugin.optionsPage = 6;
            }
            if (Input.GetKeyDown(KeyCode.Alpha8) || Input.GetKeyDown(KeyCode.Keypad8)) 
            {
                TownOfSushiPlugin.optionsPage = 7;
            }
