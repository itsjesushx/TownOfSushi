...
public static class TownOfSushiColors
{
    ...
    public static Color Sheriff => UseBasic ? Palette.CrewmateBlue : new Color32(248, 205, 70, byte.MaxValue);
    ...
    public static Color Lawyer = new Color32(112, 185, 141, byte.MaxValue);
