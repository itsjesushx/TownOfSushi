...
public static class Extensions
{
    ...
    {
        if (player.Data.Role is ITownOfSushiRole role && role.Team == team)
        {
            return true;
        }
    ...
    public static void SetRole(this ShapeshifterPanel panel, int index, RoleBehaviour roleBehaviour, Action onClick)
    {
        ...
        //else if (roleBehaviour is not ITownOfSushiRole)
        //{
        //    if (roleBehaviour is ITownOfSushiRole) teamName = "Neutral Benign";
        //    else if (roleBehaviour is ITownOfSushiRole) teamName = "Neutral Evil";
        //    else if (roleBehaviour is ITownOfSushiRole) teamName = "Neutral Killing";
    ...
    [MethodRpc((uint)TownOfSushiRpc.CatchGhost, SendImmediately = true)]
