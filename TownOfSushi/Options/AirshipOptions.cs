...
public sealed class AirshipOptions : AbstractOptionGroup
{
    ...
    public override Func<bool> GroupVisible => () =>
        (GameOptionsManager.Instance.currentGameOptions.MapId == 4) || (OptionGroupSingleton<TownOfSushiMapOptions>.Instance.RandomMaps && OptionGroupSingleton<TownOfSushiMapOptions>.Instance.AirshipChance > 0);
