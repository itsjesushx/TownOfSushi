...
public sealed class GeneralOptions : AbstractOptionGroup
{
    ...
    [ModdedToggleOption("Block Sabotage For Dead Impostors")]
    public bool DeadImpsBlockSabotage { get; set; } = false;

    [ModdedToggleOption("Limit Abilities When Only Two Players Are Alive")]
    public bool LimitAbilities { get; set; } = false;
}
