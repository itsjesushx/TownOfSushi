...
public sealed class CrewmateModifierOptions : AbstractOptionGroup
{
    ...
    public ModdedNumberOption DecayChance { get; } =
        ...
        {
            Visible = () => OptionGroupSingleton<CrewmateModifierOptions>.Instance.DecayAmount > 0
        };
    ...
    public ModdedNumberOption AdministratorChance { get; } = new("Administrator Chance", 50f, 0, 100f, 10f, MiraNumberSuffixes.Percent)
    {
        Visible = () => OptionGroupSingleton<CrewmateModifierOptions>.Instance.AdministratorAmount > 0
    };
