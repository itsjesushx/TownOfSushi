...
public sealed class CrewmateModifierOptions : AbstractOptionGroup
{
    ...
    [ModdedNumberOption("Decay Amount", 0, 5, 1)]
    public float DecayAmount { get; set; } = 0;
    public ModdedNumberOption DecayChance { get; } = new ModdedNumberOption("Decay Chance", 50f, 0, 100f, 10f, MiraNumberSuffixes.Percent)
    {
