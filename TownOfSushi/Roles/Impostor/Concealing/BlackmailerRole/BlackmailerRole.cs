...
public sealed class BlackmailerRole(IntPtr cppPtr) : ImpostorRole(cppPtr), ITOSRole, IWikiDiscoverable, IMysticClue
{
    ...
    public CustomRoleConfiguration Configuration => new(this)
    {
        ...
        Icon = TownOfSushiAssets.Blackmailer
    };
    ...
    [
        new("Blackmail",
            ...
            TownOfSushiAssets.BlackmailSprite)
    ];
