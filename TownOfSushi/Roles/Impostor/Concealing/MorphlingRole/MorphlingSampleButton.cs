...
public sealed class MorphlingSampleButton : TownOfSushiRoleButton<MorphlingRole, PlayerControl>, IAftermathablePlayerButton
{
    ...
    public override LoadableAsset<Sprite> Sprite => TownOfSushiAssets.SampleSprite;
    ...
    public void AftermathHandler()
    {
        ...
        var notif1 = Helpers.CreateAndShowNotification(
            ...
            Color.white, new Vector3(0f, 1f, -20f), spr: TownOfSushiAssets.Morphling.LoadAsset());
    ...
    protected override void OnClick()
    {
        ...
        var notif1 = Helpers.CreateAndShowNotification(Utils.ColorString(TownOfSushiColors.ImpSoft,
            ...
            Color.white, spr: TownOfSushiAssets.Morphling.LoadAsset());
