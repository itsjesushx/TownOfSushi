...
public sealed class GrenadierFlashButton : TownOfSushiRoleButton<GrenadierRole>, IAftermathableButton
{
    ...
    public override float Cooldown => OptionGroupSingleton<GrenadierOptions>.Instance.GrenadeCooldown;
    ...
    public override LoadableAsset<Sprite> Sprite => TownOfSushiAssets.FlashSprite;
    ...
    protected override void OnClick()
    {
        ...
        var notif1 = Helpers.CreateAndShowNotification(
            ...
            spr: TownOfSushiAssets.Grenadier.LoadAsset());
        notif1.AdjustNotification();

        Coroutines.Start(
            Effects.Shake(HudManager.Instance.PlayerCam.transform, 0.2f, 0.1f, true, true).WrapToManaged());

        SoundManager.Instance.PlaySound(TownOfSushiAudio.GrenadeSound.LoadAsset(), false);
    }
}