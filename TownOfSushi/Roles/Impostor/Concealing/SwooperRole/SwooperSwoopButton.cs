...
public sealed class SwooperSwoopButton : TownOfSushiRoleButton<SwooperRole>, IAftermathableButton
{
    ...
    public override float Cooldown => OptionGroupSingleton<SwooperOptions>.Instance.SwoopCooldown;
    ...
    public override LoadableAsset<Sprite> Sprite => TownOfSushiAssets.SwoopSprite;
