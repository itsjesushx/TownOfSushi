...
public sealed class VenererRole(IntPtr cppPtr) : ImpostorRole(cppPtr), ITOSRole, IWikiDiscoverable, IMysticClue
{
    ...
    {
        Icon = TownOfSushiAssets.Venerer
    };
    ...
    [
        ...
        new("Freeze",
            ...
            TownOfSushiAssets.FreezeSprite)
    ];
