...
public sealed class VenererAbilityButton : TownOfSushiRoleButton<VenererRole>, IAftermathableButton
{
    ...
    public override LoadableAsset<Sprite> Sprite => TownOfSushiAssets.NoAbilitySprite;
    ...
    public void UpdateAbility(VenererAbility ability)
    {
        ...
        if (ability != VenererAbility.None && PlayerControl.LocalPlayer.Data.Role is VenererRole)
        {
            var notif1 = Helpers.CreateAndShowNotification(
                ...
                Color.white, new Vector3(0f, 1f, -20f), spr: TownOfSushiAssets.Venerer.LoadAsset());
    ...
    private void UpdateButton(VenererAbility ability)
    {
        ...
        switch (ActiveAbility)
        {
            case VenererAbility.Camouflage:
                SetAbility("Camouflage", TownOfSushiAssets.CamouflageSprite.LoadAsset());
                break;
            case VenererAbility.Sprint:
                SetAbility("Sprint", TownOfSushiAssets.SprintSprite.LoadAsset());
                break;
            case VenererAbility.Freeze:
                SetAbility("Freeze", TownOfSushiAssets.FreezeSprite.LoadAsset());
                break;
        }
