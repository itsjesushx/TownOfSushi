...
public sealed class PoisonerRole(IntPtr cppPtr) : ImpostorRole(cppPtr), ITOSRole, IWikiDiscoverable, IMysticClue
{
    ...
    public HashSet<byte> BlindedPlayers = new HashSet<byte>();
    public CustomRoleConfiguration Configuration => new(this)
    {
        CanUseVent = OptionGroupSingleton<PoisonerOptions>.Instance.CanUseVents,
        Icon = TownOfSushiAssets.PoisonSprite,
    ...
    public static void RpcMurderPoisoned(PlayerControl source, PlayerControl target)
    {
        ...
        if (target.IsProtected())
        {
            ...
            Color.white, spr: TownOfSushiAssets.PoisonSprite.LoadAsset());            
    ...
    public List<CustomButtonWikiDescription> Abilities { get; } = [
        new("Poison",
            ...
            TownOfSushiAssets.PoisonSprite)
    ];
}