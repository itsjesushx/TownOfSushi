...
public sealed class PoisonerOptions : AbstractOptionGroup<PoisonerRole>
{
    ...
    [ModdedNumberOption("Blind Trap Cooldown", 10f, 60f, 2.5f, MiraNumberSuffixes.Seconds)]
    public float BlindTrapCooldown { get; set; } = 25f;
    [ModdedNumberOption("Blind Trap Duration", 0f, 10f, 1f, MiraNumberSuffixes.Seconds)]
    public float BlindTrapDuration { get; set; } = 7f;
