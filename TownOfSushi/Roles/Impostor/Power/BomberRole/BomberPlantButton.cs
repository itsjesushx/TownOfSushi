...
public sealed class BomberPlantButton : TownOfSushiRoleButton<BomberRole>, IAftermathableButton, IDiseaseableButton
{
    ...
    public override LoadableAsset<Sprite> Sprite => TownOfSushiAssets.PlaceSprite;
    ...
    {
        OverrideSprite(TownOfSushiAssets.DetonatingSprite.LoadAsset());
    ...
    {
        OverrideSprite(TownOfSushiAssets.PlaceSprite.LoadAsset());
        OverrideName("Place");
