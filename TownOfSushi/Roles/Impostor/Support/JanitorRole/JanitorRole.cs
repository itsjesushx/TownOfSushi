    ...
    : ImpostorRole(cppPtr), ITOSRole, IWikiDiscoverable, ICrewVariant, IMysticClue
{
    public void FixedUpdate()
    {
        ...
        HudManager.Instance.KillButton.ToggleVisible(OptionGroupSingleton<JanitorOptions>.Instance.JanitorKill ||
         (Player != null && Player.GetModifiers<BaseModifier>().Any(x => x is ICachedRole)) || (Player != null && Utils.ImpAliveCount == 1));
    }
    ...
    public CustomRoleConfiguration Configuration => new(this)
    {
        ...
        Icon = TownOfSushiAssets.Janitor,
    ...
    [
        new("Clean",
            ...
            TownOfSushiAssets.CleanButtonSprite)
    ];
