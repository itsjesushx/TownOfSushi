...
public sealed class UndertakerDragDropButton : TownOfSushiRoleButton<UndertakerRole, DeadBody>, IAftermathableBodyButton
{
    ...
    public override float Cooldown => OptionGroupSingleton<UndertakerOptions>.Instance.DragCooldown;
    public override LoadableAsset<Sprite> Sprite => TownOfSushiAssets.DragSprite;
    ...
    public void SetDrag()
    {
        OverrideSprite(TownOfSushiAssets.DragSprite.LoadAsset());
        OverrideName("Drag");
    }

    public void SetDrop()
    {
        OverrideSprite(TownOfSushiAssets.DropSprite.LoadAsset());
        OverrideName("Drop");
    }
