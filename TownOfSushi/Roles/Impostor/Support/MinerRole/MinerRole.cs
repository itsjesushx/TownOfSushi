    ...
    : ImpostorRole(cppPtr), ITOSRole, IWikiDiscoverable, ICrewVariant, IMysticClue
{
    ...
    public CustomRoleConfiguration Configuration => new(this)
    {
        ...
        Icon = TownOfSushiAssets.Miner,
        IntroSound = TownOfSushiAudio.MineSound
    };
    ...
    [
        new("Mine",
            ...
            TownOfSushiAssets.MineSprite)
    ];

    public string GetAdvancedDescription()
    {
        return "The Miner is an Impostor Support role that can create vents." + Utils.AppendOptionsText(GetType());
    }
