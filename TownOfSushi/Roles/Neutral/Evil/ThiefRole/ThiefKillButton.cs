    ...
    IKillButton
{
    ...
    protected override void OnClick()
    {
        ...
        if (Target.Data.Role is SheriffRole && OptionGroupSingleton<ThiefOptions>.Instance.CanStealSheriff)
        {
            PlayerControl.LocalPlayer.RpcCustomMurder(Target);
        }
        else if (Target.Is(Factions.Crewmate) && Target.Data.Role is not SheriffRole || !Target.IsKillerRole())
        {
