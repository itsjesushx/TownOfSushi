        ...
        if (@event.Player.GetRoleWhenAlive() is JesterRole jester && jester.AboutToWin)
        {
            ...
            if (jester.Player.AmOwner)
            {
                var notif1 = Helpers.CreateAndShowNotification(
                    $"<b>You have successfully won as the" + Utils.ColorString(TownOfSushiColors.Jester, " Jester") + ", by getting voted out!</b>",
                    Color.white, spr: TownOfSushiAssets.Jester.LoadAsset());
            ...
            {
                var notif1 = Helpers.CreateAndShowNotification(
                    $"<b>The" + Utils.ColorString(TownOfSushiColors.Jester, "Jester") + $"{jester.Player.Data.PlayerName}, has successfully won, as they were voted out!</b>",
                    Color.white, spr: TownOfSushiAssets.Jester.LoadAsset());
