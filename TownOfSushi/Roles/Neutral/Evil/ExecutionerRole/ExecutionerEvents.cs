...
public static class ExecutionerEvents
{
    ...
    public static void RoundStartEventHandler(RoundStartEvent @event)
    {
        ...
        if (exe != null)
        {
            ...
            {
                var notif1 = Helpers.CreateAndShowNotification(Utils.ColorString(TownOfSushiColors.Executioner,
                    $"<b>You have successfully won as the Executioner, as your target was exiled!</b>"),
                    Color.white, spr: TownOfSushiAssets.Executioner.LoadAsset());
                ...
                if (OptionGroupSingleton<ExecutionerOptions>.Instance.ExeWin is ExeWinOptions.Torments)
                {
                    ...
                    var notif2 = Helpers.CreateAndShowNotification(Utils.ColorString(TownOfSushiColors.Executioner,
