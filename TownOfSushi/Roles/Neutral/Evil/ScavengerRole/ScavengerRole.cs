...
public sealed class ScavengerRole(IntPtr cppPtr) : NeutralRole(cppPtr), ITOSRole, IWikiDiscoverable, IMysticClue
{
    ...
    public CustomRoleConfiguration Configuration => new(this)
    {
        ...
        IntroSound = TownOfSushiAudio.JanitorCleanSound,
        Icon = TownOfSushiAssets.EatSprite,
        MaxRoleCount = 1,
    ...
    {
        return $"The Scavenger is a Neutral Evil role that wins by being eating corpses. If they each {OptionGroupSingleton<ScavengerOptions>.Instance.EatNeed} bodies, they win." + Utils.AppendOptionsText(GetType());
    }
    [HideFromIl2Cpp]
    ...
    [
        new("Scavenge",
            ...
            TownOfSushiAssets.ScavengeSprite)
    ];
}