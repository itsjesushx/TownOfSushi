...
public sealed class ScavengerEatButton : TownOfSushiRoleButton<ScavengerRole, DeadBody>
{
    ...
    public override float Cooldown => OptionGroupSingleton<ScavengerOptions>.Instance.EatCooldown;
    public override float EffectDuration => OptionGroupSingleton<ScavengerOptions>.Instance.EatDuration + 0.001f;
    public override LoadableAsset<Sprite> Sprite => TownOfSushiAssets.EatSprite;
    ...
    public override void OnEffectEnd()
    {
        if (EatingBody == Target && EatingBody != null)
        {
            ...
            TownOfSushiAudio.PlaySound(TownOfSushiAudio.JanitorCleanSound);
        }
        EatingBody = null;
    }
}