...
public sealed class ScavengerButton : TownOfSushiButton
{
    ...
    public override float Cooldown => OptionGroupSingleton<ScavengerOptions>.Instance.ScavengeCooldown;
    ...
    public override LoadableAsset<Sprite> Sprite => TownOfSushiAssets.ScavengeSprite;
    ...
    protected override void OnClick()
    {
        ...
        {
            var notif1 = Helpers.CreateAndShowNotification($"<b>No bodies were found on the map.</b>", Color.white, new Vector3(0f, 1f, -20f), spr: TownOfSushiAssets.ScavengeSprite.LoadAsset());
