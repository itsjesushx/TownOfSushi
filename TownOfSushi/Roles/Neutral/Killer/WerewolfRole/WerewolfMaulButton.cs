...
public sealed class WerewolfMaulButton : TownOfSushiRoleButton<WerewolfRole, PlayerControl>, IDiseaseableButton, IKillButton
{
    ...
    public override float Cooldown => OptionGroupSingleton<WerewolfOptions>.Instance.MaulCooldown;
    public override LoadableAsset<Sprite> Sprite => TownOfSushiAssets.MaulSprite;
