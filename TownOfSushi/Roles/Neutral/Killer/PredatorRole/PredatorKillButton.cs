    ...
    IKillButton
{
    ...
    public override float Cooldown => OptionGroupSingleton<PredatorOptions>.Instance.TerminateKillCooldown;
    public override LoadableAsset<Sprite> Sprite => TownOfSushiAssets.PredatorKillSprite;
