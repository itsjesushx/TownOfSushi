    ...
    : NeutralRole(cppPtr), ITOSRole, IWikiDiscoverable, ICrewVariant, IMysticClue
{
    ...
    public CustomRoleConfiguration Configuration => new(this)
    {
        ...
        Icon = TownOfSushiAssets.Predator,
    ...
    {
        return
            "The Predator is a Neutral Killing role that wins by being the last killer alive. They can go on a terminating state to gain the ability to kill." +
    ...
    [
        new("Terminate",
            ...
            TownOfSushiAssets.TerminateSprite)
    ];
