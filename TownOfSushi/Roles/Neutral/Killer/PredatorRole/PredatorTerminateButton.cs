...
public sealed class PredatorTerminateButton : TownOfSushiRoleButton<PredatorRole>
{
    ...
    public override float Cooldown => OptionGroupSingleton<PredatorOptions>.Instance.TerminateCooldown;
    public override float EffectDuration => OptionGroupSingleton<PredatorOptions>.Instance.TerminateDuration;
    public override LoadableAsset<Sprite> Sprite => TownOfSushiAssets.TerminateSprite;
    ...
    protected override void OnClick()
    {
        ...
        TownOfSushiAudio.PlaySound(TownOfSushiAudio.PredatorTerminateSound);
    }
