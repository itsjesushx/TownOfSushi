...
public sealed class VampireBiteButton : TownOfSushiRoleButton<VampireRole, PlayerControl>, IDiseaseableButton, IKillButton
{
    ...
    public override float Cooldown => OptionGroupSingleton<VampireOptions>.Instance.BiteCooldown;
    public override LoadableAsset<Sprite> Sprite => TownOfSushiAssets.BiteSprite;
