...
public sealed class VampireRole(IntPtr cppPtr) : NeutralRole(cppPtr), ITOSRole, IWikiDiscoverable, IMysticClue
{
    ...
    public CustomRoleConfiguration Configuration => new(this)
    {
        ...
        Icon = TownOfSushiAssets.Vampire,
    ...
    public bool WinConditionMet()
    {
        ...
        if (Utils.KillersAliveCount > vampireCount)
        {
            return false;
        }
    ...
    public override void Initialize(PlayerControl player)
    {
        ...
        if (Player.AmOwner)
        {
            HudManager.Instance.ImpostorVentButton.graphic.sprite = TownOfSushiAssets.VampVentSprite.LoadAsset();
