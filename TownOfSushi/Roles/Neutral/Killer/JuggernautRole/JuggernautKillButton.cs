    ...
    IKillButton
{
    ...
    public override LoadableAsset<Sprite> Sprite => TownOfSushiAssets.JuggKillSprite;
    public override float Cooldown => GetCooldown();

    public static float BaseCooldown => OptionGroupSingleton<JuggernautOptions>.Instance.KillCooldown;
