...
public sealed class PyromaniacDouseButton : TownOfSushiRoleButton<PyromaniacRole, PlayerControl>
{
    ...
    public override float Cooldown => OptionGroupSingleton<PyromaniacOptions>.Instance.DouseCooldown;
    public override float EffectDuration => OptionGroupSingleton<PyromaniacOptions>.Instance.DouseDuration;
    public override LoadableAsset<Sprite> Sprite => TownOfSushiAssets.DouseButtonSprite;
