...
public sealed class PyromaniacOptions : AbstractOptionGroup<PyromaniacRole>
{
    ...
    [ModdedNumberOption("Doused Kill Cooldown", 1f, 10f, 1f, MiraNumberSuffixes.Seconds)]
    public float DousedKillCooldown { get; set; } = 5f;

    [ModdedNumberOption("Regular Kill Cooldown", 10f, 60f, 2.5f, MiraNumberSuffixes.Seconds)]
    public float RegularKillCooldown { get; set; } = 25f;
    [ModdedNumberOption("Douse Duration", 0f, 6f, 1f, MiraNumberSuffixes.Seconds)]
