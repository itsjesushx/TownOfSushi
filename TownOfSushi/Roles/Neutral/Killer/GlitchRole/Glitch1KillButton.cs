...
public sealed class GlitchKillButton : TownOfSushiRoleButton<GlitchRole, PlayerControl>, IDiseaseableButton, IKillButton
{
    ...
    public override float Cooldown => OptionGroupSingleton<GlitchOptions>.Instance.KillCooldown;
    public override LoadableAsset<Sprite> Sprite => TownOfSushiAssets.GlitchKillSprite;
