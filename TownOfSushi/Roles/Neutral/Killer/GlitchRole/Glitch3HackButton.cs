...
public sealed class GlitchHackButton : TownOfSushiRoleButton<GlitchRole, PlayerControl>, IAftermathablePlayerButton
{
    ...
    public override float Cooldown => OptionGroupSingleton<GlitchOptions>.Instance.HackCooldown;
    public override LoadableAsset<Sprite> Sprite => TownOfSushiAssets.HackSprite;
    ...
    {
        TownOfSushiAudio.PlaySound(TownOfSushiAudio.HackedSound);
    ...
    protected override void OnClick()
    {
        ...
        var notif1 = Helpers.CreateAndShowNotification(
            ...
            Color.white, new Vector3(0f, 1f, -20f), spr: TownOfSushiAssets.Glitch.LoadAsset());
