...
public sealed class EclipsalBlindButton : TownOfSushiRoleButton<EclipsalRole>, IAftermathableButton
{
    ...
    public override float Cooldown => OptionGroupSingleton<EclipsalOptions>.Instance.BlindCooldown;
    public override float EffectDuration => OptionGroupSingleton<EclipsalOptions>.Instance.BlindDuration;
    public override LoadableAsset<Sprite> Sprite => TownOfSushiAssets.BlindSprite;
    ...
    protected override void OnClick()
    {
        ...
        foreach (var player in blindedPlayers.Where(x => !x.HasDied()))
        {
