...
public sealed class EclipsalRole(IntPtr cppPtr) : NeutralRole(cppPtr), ITOSRole, IWikiDiscoverable, IMysticClue
{
    ...
    {
        Icon = TownOfSushiAssets.Eclipsal,
