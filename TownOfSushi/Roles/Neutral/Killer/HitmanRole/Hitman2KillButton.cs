...
public sealed class HitmanKillButton : TownOfSushiRoleButton<HitmanRole, PlayerControl>, IDiseaseableButton, IKillButton
{
    ...
    public override float Cooldown => OptionGroupSingleton<AgentOptions>.Instance.KillCooldown;
    public override LoadableAsset<Sprite> Sprite => TownOfSushiAssets.HitmanKillSprite;
