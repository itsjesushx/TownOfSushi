...
public class NeutralGhostRole(IntPtr cppPtr) : RoleBehaviour(cppPtr), ITOSRole
{
    ...
    public virtual Factions Faction => Factions.Neutral;
    ...
    public StringBuilder SetTabText()
    {
        ...
        if (Player.GetRoleWhenAlive() is ITOSRole touRole)
        {
            stringB = ITOSRole.SetNewTabText(touRole);
    ...
    public virtual bool WinConditionMet()
    {
        ...
        return role is ITOSRole tRole && tRole.WinConditionMet();
    }
