...
public sealed class SpectreSpookButton : TownOfSushiButton
{
    public override string Name => "Spook";
    public override BaseKeybind Keybind => Keybinds.SecondaryAction;
    public override Color TextOutlineColor => TownOfSushiColors.Spectre;
    public override float Cooldown => 0.01f;
    public override LoadableAsset<Sprite> Sprite => TOSNeutAssets.SpectreSpookSprite;
