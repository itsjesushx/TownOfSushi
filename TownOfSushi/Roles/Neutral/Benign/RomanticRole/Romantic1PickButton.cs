...
public sealed class RomanticPickButton : TownOfSushiRoleButton<RomanticRole, PlayerControl>
{
    ...
    public override LoadableAsset<Sprite> Sprite => TownOfSushiAssets.RomanticPick;
    ...
    protected override void OnClick()
    {
        ...
        var notif1 = Helpers.CreateAndShowNotification(
            Utils.ColorString(TownOfSushiColors.Romantic, $"<b>You fell in love with {Target.Data.PlayerName}. Protect them at any cost!</b>"), Color.white, spr: TownOfSushiAssets.Romantic.LoadAsset());
