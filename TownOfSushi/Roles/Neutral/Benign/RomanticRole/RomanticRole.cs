...
public sealed class RomanticRole(IntPtr cppPtr) : NeutralRole(cppPtr), ITOSRole, IMysticClue, IWikiDiscoverable
{
    ...
    public CustomRoleConfiguration Configuration => new(this)
    {
        ...
        MaxRoleCount = 1,
        Icon = TownOfSushiAssets.Romantic,
    ...
    [
        new("Protect",
            ...
            TownOfSushiAssets.ProtectSprite)
    ];

    public string GetAdvancedDescription()
    {
        return
            "The Romantic is a Neutral Benign that needs to protect their beloved from dying. The Romantic is the one that chooses their lover. If their beloved dies, the Romantic becomes a Vengeful Romantic." +
