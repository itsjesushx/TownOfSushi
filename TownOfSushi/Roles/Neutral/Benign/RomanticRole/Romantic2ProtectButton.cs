...
public sealed class RomanticProtectButton : TownOfSushiRoleButton<RomanticRole>
{
    ...
    public override float Cooldown => OptionGroupSingleton<RomanticOptions>.Instance.ProtectCooldown;
    ...
    public override LoadableAsset<Sprite> Sprite => TownOfSushiAssets.RomanticProtect;
