...
public sealed class SeerRevealButton : TownOfSushiRoleButton<SeerRole, PlayerControl>
{
    ...
    public override float Cooldown => OptionGroupSingleton<SeerOptions>.Instance.SeerCooldown;
    public override LoadableAsset<Sprite> Sprite => TownOfSushiAssets.SeerSprite;
    ...
    public static void RevealAlliance(PlayerControl target)
    {
        ...
        if (IsEvil(target))
        {
            ...
            var notif1 = Helpers.CreateAndShowNotification(Utils.ColorString(Palette.ImpostorRed,
