...
public sealed class AurialRole(IntPtr cppPtr) : CrewmateRole(cppPtr), ITOSRole, IWikiDiscoverable, IMysticClue
{
    ...
    public IEnumerator Sense(PlayerControl player)
    {
        ...
        var arrow = Utils.CreateArrow(Player.transform, color);
