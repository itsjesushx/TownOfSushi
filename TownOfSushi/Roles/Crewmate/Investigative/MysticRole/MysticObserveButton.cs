...
public sealed class MysticObserveButton : TownOfSushiRoleButton<MysticRole, PlayerControl>
{
    ...
    public override float Cooldown => OptionGroupSingleton<MysticOptions>.Instance.ObserveCooldown;
    public override LoadableAsset<Sprite> Sprite => TownOfSushiAssets.Observe;
    ...
    protected override void OnClick()
    {
        ...
        var notif1 = Helpers.CreateAndShowNotification(
            ...
            Color.white, new Vector3(0f, 1f, -20f), spr: TownOfSushiAssets.Mystic.LoadAsset());
