...
public sealed class MysticRole(IntPtr cppPtr) : CrewmateRole(cppPtr), ITOSRole, IWikiDiscoverable, IMysticClue
{
    public string RoleName => "Mystic";
    public string RoleDescription => "Know information about kills and roles";
    ...
    private void GenerateReport()
    {
        ...
        if (HudManager.Instance && report.Length > 0)
        {
            ...
            Utils.AddFakeChat(Player.Data, title, report, false, true);
        }
    }
}