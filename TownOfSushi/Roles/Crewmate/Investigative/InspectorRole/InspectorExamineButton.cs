...
public sealed class InspectorExamineButton : TownOfSushiRoleButton<InspectorRole, PlayerControl>
{
    ...
    public override float Cooldown => OptionGroupSingleton<InspectorOptions>.Instance.ExamineCooldown;
    public override LoadableAsset<Sprite> Sprite => TownOfSushiAssets.ExamineSprite;
