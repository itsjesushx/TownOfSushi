...
public sealed class InspectorRole(IntPtr cppPtr) : CrewmateRole(cppPtr), ITOSRole, IWikiDiscoverable, IMysticClue
{
    ...
    {
        Icon = TownOfSushiAssets.Inspector,
    ...
    [
        ...
        new("Examine",
            ...
            TownOfSushiAssets.ExamineSprite)
    ];
    ...
    public void ExaminePlayer(PlayerControl player)
    {
        if (InvestigatedPlayers.Contains(player.PlayerId))
        {
            ...
            var notif1 = Helpers.CreateAndShowNotification(Utils.ColorString(TownOfSushiColors.Inspector,
                $"<b>{player.Data.PlayerName} was at the scene of {deadPlayer.Data.PlayerName}'s death!\nThey might be the killer or a witness.</b>"),
                Color.white, new Vector3(0f, 1f, -20f), spr: TownOfSushiAssets.Inspector.LoadAsset());
