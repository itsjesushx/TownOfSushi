...
public sealed class SnitchRole(IntPtr cppPtr) : CrewmateRole(cppPtr), ITownOfSushiRole, IWikiDiscoverable, IDoomable
{
    ...
    public void CheckTaskRequirements()
    {
        ...
        if (IsTargetOfSnitch(PlayerControl.LocalPlayer) && OnLastTask)
        {
            ...
            var notif1 = Helpers.CreateAndShowNotification(
                $"<b>{TownOfSushiColors.Snitch.ToTextColor()}{text}</color></b>", Color.white, spr: TosRoleIcons.Snitch.LoadAsset());
