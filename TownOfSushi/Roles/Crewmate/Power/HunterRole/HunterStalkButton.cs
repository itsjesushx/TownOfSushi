...
public sealed class HunterStalkButton : TownOfSushiRoleButton<HunterRole, PlayerControl>
{
    ...
    public override float Cooldown => OptionGroupSingleton<HunterOptions>.Instance.HunterStalkCooldown;
    ...
    public override LoadableAsset<Sprite> Sprite => TownOfSushiAssets.StalkButtonSprite;
    ...
    protected override void OnClick()
    {
        ...
        var notif1 = Helpers.CreateAndShowNotification(
            ...
            Color.white, new Vector3(0f, 1f, -20f), spr: TownOfSushiAssets.Hunter.LoadAsset());
