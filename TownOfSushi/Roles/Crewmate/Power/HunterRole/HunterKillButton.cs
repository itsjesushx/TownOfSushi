...
public sealed class HunterKillButton : TownOfSushiRoleButton<HunterRole, PlayerControl>, IDiseaseableButton, IKillButton
{
    ...
    public override float Cooldown => OptionGroupSingleton<HunterOptions>.Instance.HunterKillCooldown;
    public override LoadableAsset<Sprite> Sprite => TownOfSushiAssets.HunterKillSprite;
