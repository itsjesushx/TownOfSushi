...
public sealed class JailorJailButton : TownOfSushiRoleButton<JailorRole, PlayerControl>
{
    ...
    public override float Cooldown => OptionGroupSingleton<JailorOptions>.Instance.JailCooldown;
    public override LoadableAsset<Sprite> Sprite => TownOfSushiAssets.JailSprite;
    ...
    protected override void OnClick()
    {
        ...
        TownOfSushiAudio.PlaySound(TownOfSushiAudio.JailSound);
    }
}