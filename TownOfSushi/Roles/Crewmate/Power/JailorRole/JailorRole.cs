...
public sealed class JailorRole(IntPtr cppPtr) : CrewmateRole(cppPtr), ITOSCrewRole, IWikiDiscoverable, IMysticClue
{
    ...
    public StringBuilder SetTabText()
    {
        ...
        {
            stringB.AppendLine(TownOfSushiPlugin.Culture, $"You can execute crewmates.");
        }
    ...
    public override void OnMeetingStart()
    {
        ...
        if (Player.AmOwner)
        {
            ...
            Utils.AddFakeChat(Jailed.Data, title, "Communicate with your jailee in the Jailor chat (inside the chat there is a bubble)", false,
                true);
        }
    ...
    private void GenButton(PlayerVoteArea voteArea)
    {
        ...
        renderer.sprite = TownOfSushiAssets.ExecuteSprite.LoadAsset();
    ...
    private Action Execute()
    {
        void Listener()
        {
            ...
            {
                if (Jailed.Is(Factions.Crewmate) && !(PlayerControl.LocalPlayer.TryGetModifier<AllianceGameModifier>(out var allyMod) &&
                ...
                {
                    Coroutines.Start(Utils.CoFlash(Color.green));
            ...
            var notif1 = Helpers.CreateAndShowNotification(
                $"<b>{text}</b>", Color.white, spr: TownOfSushiAssets.Jailor.LoadAsset());
