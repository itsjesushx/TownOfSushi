...
public sealed class VeteranAlertButton : TownOfSushiRoleButton<VeteranRole>
{
    ...
    public override float Cooldown => OptionGroupSingleton<VeteranOptions>.Instance.AlertCooldown;
    ...
    public override LoadableAsset<Sprite> Sprite => TownOfSushiAssets.AlertSprite;
