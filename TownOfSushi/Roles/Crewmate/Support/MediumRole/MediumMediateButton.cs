...
public sealed class MediumMediateButton : TownOfSushiRoleButton<MediumRole>
{
    ...
    public override float Cooldown => OptionGroupSingleton<MediumOptions>.Instance.MediateCooldown;
    public override LoadableAsset<Sprite> Sprite => TownOfSushiAssets.MediateSprite;
