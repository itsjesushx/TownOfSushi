...
public sealed class MediumRole(IntPtr cppPtr) : CrewmateRole(cppPtr), ITOSRole, IWikiDiscoverable, IMysticClue
{
    ...
    [
        new("Mediate",
            ...
            TownOfSushiAssets.MediateSprite)
    ];
