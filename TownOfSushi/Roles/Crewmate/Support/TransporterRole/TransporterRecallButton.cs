...
public sealed class TransporterRecallButton : TownOfSushiRoleButton<TransporterRole>
{
    ...
    public override float Cooldown => OptionGroupSingleton<TransporterOptions>.Instance.RecallCooldown;
    public override int MaxUses => (int)OptionGroupSingleton<TransporterOptions>.Instance.MaxEscapes;
    public override LoadableAsset<Sprite> Sprite => TownOfSushiAssets.RecallSprite;
    ...
    protected override void OnClick()
    {
        ...
        // TownOfSushiAudio.PlaySound(TownOfSushiAudio.TransporterRecallSound);
    }
