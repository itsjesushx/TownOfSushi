...
public sealed class MonarchRole(IntPtr cppPtr) : CrewmateRole(cppPtr), ITOSRole, IWikiDiscoverable, IMysticClue
{
    ...
    {
        Icon = TownOfSushiAssets.KnightSprite,
        MaxRoleCount = 1,
        DefaultRoleCount = 0,
        DefaultChance = 0,
    };
    ...
    public List<CustomButtonWikiDescription> Abilities { get; } = [
        new("Knight", 
            ...
            TownOfSushiAssets.KnightSprite)
    ];
}