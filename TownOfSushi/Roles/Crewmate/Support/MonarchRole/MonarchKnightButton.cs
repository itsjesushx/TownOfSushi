...
public sealed class KnightButton : TownOfSushiRoleButton<MonarchRole, PlayerControl>
{
    ...
    public override float Cooldown => OptionGroupSingleton<MonarchOptions>.Instance.KnightCooldown;
    public override LoadableAsset<Sprite> Sprite => TownOfSushiAssets.KnightSprite;
    ...
    protected override void OnClick()
    {
        ...
        Usable = false;
        var notif1 = Helpers.CreateAndShowNotification(Utils.ColorString(TownOfSushiColors.Monarch,$"<b>You have knighted{Target.Data.PlayerName}, they will have an extra vote each meeting as long as you're alive.</color></b>"), Color.white, new Vector3(0f, 1f, -20f), spr: TownOfSushiAssets.KnightSprite.LoadAsset());
