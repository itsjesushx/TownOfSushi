...
public sealed class PlumberFlushButton : TownOfSushiRoleButton<PlumberRole, Vent>
{
    ...
    public override float Cooldown => OptionGroupSingleton<PlumberOptions>.Instance.FlushCooldown;
    public override LoadableAsset<Sprite> Sprite => TownOfSushiAssets.FlushSprite;
