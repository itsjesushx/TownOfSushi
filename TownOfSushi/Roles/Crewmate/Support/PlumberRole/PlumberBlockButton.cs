...
public sealed class PlumberBlockButton : TownOfSushiRoleButton<PlumberRole, Vent>
{
    ...
    public override float Cooldown => OptionGroupSingleton<PlumberOptions>.Instance.BlockCooldown;
    public override int MaxUses => (int)OptionGroupSingleton<PlumberOptions>.Instance.MaxBarricades;
    public override LoadableAsset<Sprite> Sprite => TownOfSushiAssets.BarricadeSprite;
    ...
    protected override void OnClick()
    {
        ...
        var notif1 = Helpers.CreateAndShowNotification(Utils.ColorString(TownOfSushiColors.Plumber,
            $"<b>This vent will be blocked at the beginning of the next round.</b>"),
            Color.white, new Vector3(0f, 1f, -20f), spr: TownOfSushiAssets.Plumber.LoadAsset());
