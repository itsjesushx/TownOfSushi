...
public sealed class EngineerTOSRole(IntPtr cppPtr) : CrewmateRole(cppPtr), ITOSRole, IWikiDiscoverable, IMysticClue
{
    ...
    {
        // CanUseVent = true,
        Icon = TownOfSushiAssets.Engineer,
    ...
    [
        new("Fix",
            ...
            TownOfSushiAssets.FixButtonSprite)
    ];
