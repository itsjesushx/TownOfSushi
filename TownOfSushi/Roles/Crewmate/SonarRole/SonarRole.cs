...
public sealed class SonarRole(IntPtr cppPtr) : CrewmateRole(cppPtr), ITownOfSushiRole, IWikiDiscoverable, IMysticClue
{
    public override bool IsAffectedByComms => false;
    public string RoleName => "Sonar";
    ...
    public Color RoleColor => TownOfSushiColors.Sonar;
    public ModdedRoleTeams Team => ModdedRoleTeams.Crewmate;
    public RoleAlignment RoleAlignment => RoleAlignment.CrewmateInvestigative;

    public CustomRoleConfiguration Configuration => new(this)
    {
        Icon = TOSRoleIcons.Sonar,
    ...
    {
        return
            "The Sonar is a Crewmate Investigative role that can track other players to see their general position across the map, getting colored arrows towards all tracked players."
    ...
    [
        new("Track",
            ...
            "It will disappear if they die, or depending on settings, the Sonars will be reset after a meeting.",
