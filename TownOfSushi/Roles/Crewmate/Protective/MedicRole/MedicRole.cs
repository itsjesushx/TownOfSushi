...
public sealed class MedicRole(IntPtr cppPtr) : CrewmateRole(cppPtr), ITOSRole, IWikiDiscoverable, IMysticClue
{
    ...
    public override void Initialize(PlayerControl player)
    {
        ...
        if (Player.AmOwner)
        {
            meetingMenu = new MeetingMenu(
                ...
                TownOfSushiAssets.LighterSprite,
                null!,
    ...
    public override void OnMeetingStart()
    {
        ...
        if (Player.AmOwner)
        {
            ...
            foreach (var button in meetingMenu.Buttons)
            {
                ...
                var player = Utils.PlayerById(button.Key);
                ...
                {
                    "lighter" => TownOfSushiAssets.LighterSprite.LoadAsset(),
                    _ => TownOfSushiAssets.DarkerSprite.LoadAsset()
                };
            }
        }
    }
    ...
    public void Report(byte deadPlayerId)
    {
        ...
        var br = new BodyReport
        {
            ...
            Reporter = Player,
            Body = Utils.PlayerById(killer.VictimId),
        ...
        Utils.AddFakeChat(reported.Data, title, reportMsg, false, true);
    }
    ...
    {
        Coroutines.Start(Utils.CoFlash(new Color(0f, 0.5f, 0f, 1f)));
    }
