...
public sealed class MedicShieldModifier(PlayerControl medic) : BaseShieldModifier
{
    ...
    public override LoadableAsset<Sprite>? ModifierIcon => TownOfSushiAssets.Medic;
    ...
    public override void OnActivate()
    {
        ...
        MedicShield = AnimStore.SpawnAnimBody(Player, TownOfSushiAssets.MedicShield.LoadAsset(), false, -1.1f, -0.1f, 1.5f)!;
    }
