...
public sealed class CrusaderRole(IntPtr cppPtr) : CrewmateRole(cppPtr), ITOSRole, IWikiDiscoverable, IMysticClue
{
    ...
    public CustomRoleConfiguration Configuration => new(this)
    {
        ...
        Icon = TownOfSushiAssets.Crusader
    };
    ...
    [
        new("Fortify",
            ...
            TownOfSushiAssets.FortifySprite)
    ];
    ...
    public static void RpcCrusaderFortifyMurder(PlayerControl target, PlayerControl attacker)
    {
        ...
        if (attacker.AmOwner)
        {
            var notif = Helpers.CreateAndShowNotification(Utils.ColorString(TownOfSushiColors.Crusader,
    ...
    public static void RpcCrusaderNotify(PlayerControl player, PlayerControl source, PlayerControl target)
    {
        ...
        if (player.AmOwner)
        {
            Coroutines.Start(Utils.CoFlash(TownOfSushiColors.Crusader));
        }
