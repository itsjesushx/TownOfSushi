...
public sealed class CrusaderFortifiedModifier(PlayerControl Crusader) : BaseShieldModifier
{
    ...
    public override LoadableAsset<Sprite>? ModifierIcon => TownOfSushiAssets.Crusader;
    ...
    public override void OnActivate()
    {
        ...
        CrusaderFort = AnimStore.SpawnAnimBody(Player, TownOfSushiAssets.WardenFort.LoadAsset(), false, -1.1f, -0.35f, 1.5f)!;
