...
public sealed class SecurityButton : TownOfSushiButton
{
    ...
    protected override void OnClick()
    {
        ...
        var basicCams = UnityEngine.Object.FindObjectsOfType<SystemConsole>().FirstOrDefault(x =>
        ...
        {
            basicCams = UnityEngine.Object.FindObjectsOfType<SystemConsole>()
        ...
        else if (GameOptionsManager.Instance.currentNormalGameOptions.MapId == 6)
        {
            basicCams = UnityEngine.Object.FindObjectsOfType<SystemConsole>()
