...
public static class AftermathEvents
{
    ...
    public static void AftermathDeathEvent(AfterMurderEvent @event)
    {
        ...
        var notif1 = Helpers.CreateAndShowNotification(
            $"<b>{TownOfSushiColors.Aftermath.ToTextColor()}{@event.Target.Data.PlayerName} was an Aftermath, forcing you to use your ability.</color></b>", Color.white, spr: TosModifierIcons.Aftermath.LoadAsset());
        ...
        switch (button)
        {
            ...
            case IAftermathableBodyButton bodyButton:
                bodyButton.Target = source.GetNearestDeadBody(2f); // By logic, the closest body *should* be the one that just appeared
                break;
        }
