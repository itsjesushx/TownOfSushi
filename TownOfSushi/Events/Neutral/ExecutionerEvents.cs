        ...
        if (role is ExecutionerRole exe && exe.TargetVoted && OptionGroupSingleton<ExecutionerOptions>.Instance.ExeWin is ExeWinOptions.Torments)
        {
            if (exe.Player.AmOwner)
            {
                ...
                var notif1 = Helpers.CreateAndShowNotification(
                    $"<b>You have successfully won as the {TownOfSushiColors.Executioner.ToTextColor()}Executioner</color>, as your target was exiled!</b>", Color.white, spr: TosRoleIcons.Executioner.LoadAsset());
            ...
            {
                var notif1 = Helpers.CreateAndShowNotification(
                    $"<b>The {TownOfSushiColors.Executioner.ToTextColor()}Executioner</color>, {exe.Player.Data.PlayerName}, has successfully won, as their target was exiled!</b>", Color.white, spr: TosRoleIcons.Executioner.LoadAsset());
