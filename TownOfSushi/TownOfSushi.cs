    ...
    public static class TownOfSushi
    {
        ...
        public static class Hitman
        {
            ...
            public static Sprite GetDragButtonSprite()
            {
                ...
                DragSprite1 = Helpers.LoadSpriteFromResources("TownOfSushi.Resources.Drag.png", 115f);
                return DragSprite1;
            }
            public static Sprite GetDropButtonSprite()
            {
                if (DragSprite2) return DragSprite2;
                DragSprite2 = Helpers.LoadSpriteFromResources("TownOfSushi.Resources.Drop.png", 115f);
                return DragSprite2;
            }
