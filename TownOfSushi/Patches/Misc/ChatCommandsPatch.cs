             ...
             PlayerControl.LocalPlayer.Data.Role is VampireRole || PlayerControl.LocalPlayer.IsImpostor()))
        {
            ...
            if (PlayerControl.LocalPlayer.Data.Role is JailorRole)
            {
                ...
                MiscUtils.AddTeamChat(PlayerControl.LocalPlayer.Data,
                    $"<color=#{TownOfSushiColors.Jailor.ToHtmlStringRGBA()}>{PlayerControl.LocalPlayer.Data.PlayerName} (Jailor)</color>",
            ...
            if (PlayerControl.LocalPlayer.IsJailed())
            {
                ...
                MiscUtils.AddTeamChat(PlayerControl.LocalPlayer.Data,
                    $"<color=#{TownOfSushiColors.Jailor.ToHtmlStringRGBA()}>{PlayerControl.LocalPlayer.Data.PlayerName} (Jailed)</color>",
                    textRegular, onLeft: false);
            ...
            if (PlayerControl.LocalPlayer.Data.Role is VampireRole && genOpt.VampireChat)
            {
                ...
                MiscUtils.AddTeamChat(PlayerControl.LocalPlayer.Data,
                    $"<color=#{TownOfSushiColors.Vampire.ToHtmlStringRGBA()}>{PlayerControl.LocalPlayer.Data.PlayerName} (Vampire Chat)</color>",
                    textRegular, onLeft: false);
                ...
                && !MiscUtils.SpyInGame()) // Impostors don't have a chat if spy exists!!!
            {
                ...
                MiscUtils.AddTeamChat(PlayerControl.LocalPlayer.Data,
                    $"<color=#{TownOfSushiColors.ImpSoft.ToHtmlStringRGBA()}>{PlayerControl.LocalPlayer.Data.PlayerName} (Impostor Chat)</color>",
                    textRegular, onLeft: false);
