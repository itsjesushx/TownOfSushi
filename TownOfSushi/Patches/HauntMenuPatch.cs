...
namespace TownOfSushi.Patches
{
    ...
    public static class HauntMenuMinigamePatch
    {
        public static void Postfix(HauntMenuMinigame __instance)
        {
            ...
            var body = UnityEngine.Object.FindObjectsOfType<DeadBody>().FirstOrDefault(x => x.ParentId == PlayerControl.LocalPlayer.PlayerId);
            ...
            if (target.Data.IsDead && role is not ModdedPhantomRole or GuardianAngelRole or HaunterRole)
            {
