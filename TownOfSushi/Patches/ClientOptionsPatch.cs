...
namespace TownOfSushi.Patches 
{
    ...
    public static class ClientOptionsPatch
    {
        ...
        {
            new("Ghosts See Tasks & Other Info", () => TownOfSushi.GhostsSeeInformation.Value = !TownOfSushi.GhostsSeeInformation.Value, TownOfSushi.GhostsSeeInformation.Value),
            new("Ghosts Can See Votes", () => TownOfSushi.GhostsSeeVotes.Value = !TownOfSushi.GhostsSeeVotes.Value, TownOfSushi.GhostsSeeVotes.Value),
            new("Ghosts Can See Roles/Modifiers/Abilities", () => TownOfSushi.GhostsSeeEverything.Value = !TownOfSushi.GhostsSeeEverything.Value, TownOfSushi.GhostsSeeEverything.Value),
            new("Show Lighter / Darker", () => TownOfSushi.ShowLighterDarker.Value = !TownOfSushi.ShowLighterDarker.Value, TownOfSushi.ShowLighterDarker.Value),
            new("Enable Sound Effects", () => TownOfSushi.EnableSoundEffects.Value = !TownOfSushi.EnableSoundEffects.Value, TownOfSushi.EnableSoundEffects.Value),
            new("Show Vents On Map", () => TownOfSushi.ShowVentsOnMap.Value = !TownOfSushi.ShowVentsOnMap.Value, TownOfSushi.ShowVentsOnMap.Value),
            new("Show Chat Notifications", () => TownOfSushi.ShowChatNotifications.Value = !TownOfSushi.ShowChatNotifications.Value, TownOfSushi.ShowChatNotifications.Value),
            new("Disable Lobby Music", () => TownOfSushi.DisableLobbyMusic.Value = !TownOfSushi.DisableLobbyMusic.Value, TownOfSushi.DisableLobbyMusic.Value),
        };
