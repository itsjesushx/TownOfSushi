...
public static class LocalSettings
{
    private static SelectionBehaviour[] AllOptions = [
            ...
            new()
            {
                ...
                OnClick = () => { return TownOfSushiPlugin.ShowWelcomeMessage.Value = !TownOfSushiPlugin.ShowWelcomeMessage.Value; },
            ...
            new()
            {
                ...
                OnClick = () => { return TownOfSushiPlugin.ShowSummaryMessage.Value = !TownOfSushiPlugin.ShowSummaryMessage.Value; },
            ...
            new()
            {
                ...
                OnClick = () => { return TownOfSushiPlugin.ColorPlayerName.Value = !TownOfSushiPlugin.ColorPlayerName.Value; },
                DefaultValue = TownOfSushiPlugin.ColorPlayerName.Value
            },
            new()
            {
            ...
            new()
            {
                ...
                OnClick = () =>
                {
                    if (HudManager.InstanceExists) HudManagerPatches.ResizeUI(1f / TownOfSushiPlugin.ButtonUIFactor.Value);
                    ...
                    if (HudManager.InstanceExists) HudManagerPatches.ResizeUI(TownOfSushiPlugin.ButtonUIFactor.Value);
            ...
            new()
            {
                ...
                OnClick = () => { return TownOfSushiPlugin.SortGuessingByAlignment.Value = !TownOfSushiPlugin.SortGuessingByAlignment.Value; },
    ...
    public static void HideGhosts()
    {
        ...
        foreach (var player in PlayerControl.AllPlayerControls)
        {
            ...
            {
                case ModdedPhantomRole { Caught: false }:
