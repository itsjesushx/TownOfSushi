...
namespace TownOfSushi.Patches 
{
    ...
    public static class HauntMenuMinigamePatch 
    {
        ...
        public static void Postfix(HauntMenuMinigame __instance) 
        {
            ...
            var role = Role.GetRoleInfoForPlayer(target);
            string roleString = (role.Count > 0 && TownOfSushi.GhostsSeeEverything.Value) ? role[0].Name : "";
        ...
        {
            if (GameOptionsManager.Instance.currentGameOptions.GameMode != GameModes.Normal || !TownOfSushi.GhostsSeeEverything.Value) return true;
