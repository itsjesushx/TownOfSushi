...
public static class TownOfSushiAudio
{
    ...
    public static LoadableAsset<AudioClip> JailSound { get; } = 
        new LoadableAudioResourceAsset($"{AudioPath}.Jail.wav");
    ...
    public static LoadableAsset<AudioClip> EngiFix1 { get; } = 
        new LoadableAudioResourceAsset($"{AudioPath}.Fix1.wav");
    public static LoadableAsset<AudioClip> EngiFix2 { get; } = 
        new LoadableAudioResourceAsset($"{AudioPath}.Fix2.wav");
    public static LoadableAsset<AudioClip> EngiFix3 { get; } = 
        new LoadableAudioResourceAsset($"{AudioPath}.Fix3.wav");
    ...
    public static LoadableAsset<AudioClip> MineSound { get; } = 
        new LoadableAudioResourceAsset($"{AudioPath}.Mine.wav");
