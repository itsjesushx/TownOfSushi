...
public static class TosAssets
{
    private const string ShortPath = "TownOfSushi.Resources";
    private const string CounterPath = "TownOfSushi.Resources.AbilityCounters";
    ...
    public static LoadableAsset<Sprite> Logo { get; } = new LoadableResourceAsset($"{ShortPath}.Logo.png");
