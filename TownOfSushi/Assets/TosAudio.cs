...
public static class TosAudio
{
    ...
    public static LoadableAsset<AudioClip> AltruistReviveSound { get; } = new LoadableAudioResourceAsset($"{AudioPath}.Altruist.wav");

    public static LoadableAsset<AudioClip> JailSound { get; } = new LoadableAudioResourceAsset($"{AudioPath}.Jail.wav");
    public static LoadableAsset<AudioClip> MayorRevealSound { get; } = new LoadableAudioResourceAsset($"{AudioPath}.MayorReveal.wav");

    public static LoadableAsset<AudioClip> MediumIntroSound { get; } = new LoadableAudioResourceAsset($"{AudioPath}.MediumIntro.wav");
    public static LoadableAsset<AudioClip> TimeLordIntroSound { get; } = new LoadableAudioResourceAsset($"{AudioPath}.TimeLordIntro.wav");
    ...
    public static LoadableAsset<AudioClip> MimicSound { get; } = new LoadableAudioResourceAsset($"{AudioPath}.Mimic.wav");
    public static LoadableAsset<AudioClip> UnmimicSound { get; } = new LoadableAudioResourceAsset($"{AudioPath}.Unmimic.wav");
    public static LoadableAsset<AudioClip> ArsoIgniteSound { get; } = new LoadableAudioResourceAsset($"{AudioPath}.ArsonistIgnite.wav");
    public static LoadableAsset<AudioClip> WerewolfRampageSound { get; } = new LoadableAudioResourceAsset($"{AudioPath}.WerewolfRampage.wav");
    
    public static LoadableAsset<AudioClip> GrenadeSound { get; } = new LoadableAudioResourceAsset($"{AudioPath}.GrenadeThrow.wav");
    public static LoadableAsset<AudioClip> WarlockIntroSound { get; } = new LoadableAudioResourceAsset($"{AudioPath}.WarlockIntro.wav");
    public static LoadableAsset<AudioClip> SwooperActivateSound { get; } = new LoadableAudioResourceAsset($"{AudioPath}.SwooperActivate.wav");
    public static LoadableAsset<AudioClip> SwooperDeactivateSound { get; } = new LoadableAudioResourceAsset($"{AudioPath}.SwooperDeactivate.wav");
    public static LoadableAsset<AudioClip> MineSound { get; } = new LoadableAudioResourceAsset($"{AudioPath}.Mine.wav");
    public static LoadableAsset<AudioClip> EscapistMarkSound { get; } = new LoadableAudioResourceAsset($"{AudioPath}.EscapistMark.wav");
    public static LoadableAsset<AudioClip> EscapistRecallSound { get; } = new LoadableAudioResourceAsset($"{AudioPath}.EscapistRecall.wav");
    public static LoadableAsset<AudioClip> JanitorCleanSound { get; } = new LoadableAudioResourceAsset($"{AudioPath}.JanitorClean.wav");

    public static void PlaySound(LoadableAsset<AudioClip> clip, float vol = 1f)
    {
        if (Constants.ShouldPlaySfx())
        {
            SoundManager.Instance.PlaySound(clip.LoadAsset(), false, volume: vol);
        }
    }
}