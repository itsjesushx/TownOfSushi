        ...
        public static bool Prefix(KillButton __instance)
        {
            ...
            else if (interact[0] == true)
            {
                if (PlayerControl.LocalPlayer.Is(RoleEnum.BountyHunter))
                {
                    ...
                    else PlayerControl.LocalPlayer.SetKillTimer(OptionsManager().currentNormalGameOptions.KillCooldown * CustomGameOptions.BountyHunterIncorrectCd);
                }
                ...
                else PlayerControl.LocalPlayer.SetKillTimer(OptionsManager().currentNormalGameOptions.KillCooldown);
                return false;
            }
