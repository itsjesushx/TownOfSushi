...
namespace TownOfSushi.Roles.Abilities.AbilityMod.ChameleonAbility
{
    ...
    public class HudManagerUpdate
    {
        public static void Postfix(HudManager __instance)
        {
            ...
            foreach (var modifier in Ability.AllAbilities.Where(x => x.AbilityType == AbilityEnum.Chameleon))
            {
