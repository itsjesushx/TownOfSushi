...
namespace TownOfSushi.Roles.Modifiers
{
    public class Assassin : Ability
    {
        ...
        public Assassin(PlayerControl player) : base(player)
        {
            ...
            if (!PlayerControl.LocalPlayer.Is(Faction.Impostors)) ColorMapping.Add("Impostor", ColorManager.ImpostorRed);
            if (CustomGameOptions.BomberOn > 0 && !PlayerControl.LocalPlayer.Is(Faction.Impostors)) ColorMapping.Add("Bomber", ColorManager.ImpostorRed);
            if (CustomGameOptions.BlackmailerOn > 0 && !PlayerControl.LocalPlayer.Is(Faction.Impostors)) ColorMapping.Add("Blackmailer", ColorManager.ImpostorRed);
            if (CustomGameOptions.EscapistOn > 0 && !PlayerControl.LocalPlayer.Is(Faction.Impostors)) ColorMapping.Add("Escapist", ColorManager.ImpostorRed);
            if (CustomGameOptions.WitchOn > 0 && !PlayerControl.LocalPlayer.Is(Faction.Impostors)) ColorMapping.Add("Witch", ColorManager.ImpostorRed);
            if (CustomGameOptions.GrenadierOn > 0 && !PlayerControl.LocalPlayer.Is(Faction.Impostors)) ColorMapping.Add("Grenadier", ColorManager.ImpostorRed);
            if (CustomGameOptions.JanitorOn > 0 && !PlayerControl.LocalPlayer.Is(Faction.Impostors)) ColorMapping.Add("Janitor", ColorManager.ImpostorRed);
            if (CustomGameOptions.MorphlingOn > 0 && !PlayerControl.LocalPlayer.Is(Faction.Impostors)) ColorMapping.Add("Morphling", ColorManager.ImpostorRed);
            if (CustomGameOptions.MinerOn > 0 && !IsFungleMap() && !PlayerControl.LocalPlayer.Is(Faction.Impostors)) ColorMapping.Add("Miner", ColorManager.ImpostorRed);
            if (CustomGameOptions.MinerOn > 0 && IsFungleMap() && !PlayerControl.LocalPlayer.Is(Faction.Impostors)) ColorMapping.Add("Herbalist", ColorManager.ImpostorRed);
            if (CustomGameOptions.SwooperOn > 0 && !PlayerControl.LocalPlayer.Is(Faction.Impostors)) ColorMapping.Add("Swooper", ColorManager.ImpostorRed);
            if (CustomGameOptions.PoisonerOn > 0 && !PlayerControl.LocalPlayer.Is(Faction.Impostors)) ColorMapping.Add("Poisoner", ColorManager.ImpostorRed);
            if (CustomGameOptions.BountyHunterOn > 0 && !PlayerControl.LocalPlayer.Is(Faction.Impostors)) ColorMapping.Add("Bounty Hunter", ColorManager.ImpostorRed);
            if (CustomGameOptions.VenererOn > 0 && !PlayerControl.LocalPlayer.Is(Faction.Impostors)) ColorMapping.Add("Venerer", ColorManager.ImpostorRed);
            if (CustomGameOptions.UndertakerOn > 0 && !PlayerControl.LocalPlayer.Is(Faction.Impostors)) ColorMapping.Add("Undertaker", ColorManager.ImpostorRed);
            if (CustomGameOptions.WarlockOn > 0 && !PlayerControl.LocalPlayer.Is(Faction.Impostors)) ColorMapping.Add("Warlock", ColorManager.ImpostorRed);
