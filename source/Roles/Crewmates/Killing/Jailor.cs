...
namespace TownOfSushi.Roles
{
    ...
    public class HudJail
    {
        ...
        public static void Postfix(HudManager __instance)
        {
            ...
            jailButton.transform.localPosition = new Vector3(-2f, -0.06f, 0);
    ...
    public class MeetingStartJailor
    {
        public static void Postfix(MeetingHud __instance)
        {
            ...
            if (PlayerControl.LocalPlayer.IsJailed())
            {
                ...
                {
                    Chat().AddChat(PlayerControl.LocalPlayer, "You are jailed, provide relevant information to the Jailor to prove you are Crew");
                }
                else
                {
                    Chat().AddChat(PlayerControl.LocalPlayer, "You are jailed, convince the Jailor that you are Crew to avoid being executed");
                }
            }
            else if (PlayerControl.LocalPlayer.Is(RoleEnum.Jailor))
            {
                ...
                if (jailor.Jailed.Data.IsDead || jailor.Jailed.Data.Disconnected) return;
                Chat().AddChat(PlayerControl.LocalPlayer, "Use /jail to communicate with your jailee");
            }
        }
    }
