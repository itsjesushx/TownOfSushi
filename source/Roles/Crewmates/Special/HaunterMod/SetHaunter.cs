namespace TownOfSushi.Roles.Crewmates.Special.HaunterMod
{
    ...
    public class SetHaunter
    {
        ...
        public static void ExileControllerPostfix(ExileController __instance)
        {
            ...
            if (!WillBeHaunter.Data.IsDead && exiled.Is(Faction.Crewmates)) WillBeHaunter = exiled;
            ...
            {
                var oldRole = GetPlayerRole(WillBeHaunter);
                var killsList = (oldRole.CorrectKills, oldRole.CorrectAssassinKills, oldRole.IncorrectAssassinKills);
                RoleDictionary.Remove(WillBeHaunter.PlayerId);
            ...
            if (GetRole<Haunter>(PlayerControl.LocalPlayer).Caught) return;
