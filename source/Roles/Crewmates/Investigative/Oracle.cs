namespace TownOfSushi.Roles
{
    ...
    public class HudConfess
    {
        ...
        public static void Postfix(HudManager __instance)
        {
            ...
            confessButton.transform.localPosition = new Vector3(-2f, -0.06f, 0);
    ...
    public class MeetingStartOracle
    {
        ...
        public static string PlayerReportFeedback(PlayerControl player)
        {
            ...
            var allPlayers = AllPlayers().Where(x => !x.Data.IsDead && !x.Data.Disconnected && x != PlayerControl.LocalPlayer&& x != player).ToList();
