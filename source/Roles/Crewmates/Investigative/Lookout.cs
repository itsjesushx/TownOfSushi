...
namespace TownOfSushi.Roles
{
    ...
    public class PerformWatch
    {
        ...
        public static bool Prefix(KillButton __instance)
        {
            ...
            var maxDistance = NormalGameOptionsV09.KillDistances[OptionsManager().currentNormalGameOptions.KillDistance];
    ...
    public class LookoutMeetingStart
    {
        public static void Postfix(MeetingHud __instance)
        {
            ...
            foreach (var (key, value) in loRole.Watching)
            {
                ...
                {
                    if (HUDManager())
                        Chat().AddChat(PlayerControl.LocalPlayer, $"No players interacted with {name}");
                }
                else
                {
    ...
    public class LookoutHudTrack
    {
        ...
        public static void Postfix(HudManager __instance)
        {
            ...
            watchButton.transform.localPosition = new Vector3(-2f, -0.06f, 0);
