...
namespace TownOfSushi.Roles
{
    ...
    public class HudTrap
    {
        ...
        public static void UpdateTrapButton(HudManager __instance)
        {
            ...
            trapButton.transform.localPosition = new Vector3(-2f, -0.06f, 0);
    ...
    public class MeetingStartTrapper
    {
        public static void Postfix(MeetingHud __instance)
        {
            ...
            if (trapperRole.trappedPlayers.Count == 0)
                {
                    Chat().AddChat(PlayerControl.LocalPlayer, ColorString(Color.red, "No players entered any of your traps"));
                }
                else if (trapperRole.trappedPlayers.Count < CustomGameOptions.MinAmountOfPlayersInTrap)
                {
                    Chat().AddChat(PlayerControl.LocalPlayer, ColorString(Color.red, "Not enough players triggered your traps"));
                }
            else
            {
                ...
                if (HUDManager())
                    Chat().AddChat(PlayerControl.LocalPlayer, message);
            }
        }
    }
