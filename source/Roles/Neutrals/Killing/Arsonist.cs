namespace TownOfSushi.Roles
{
    public class Arsonist : Role
    {
        ...
        public static Sprite GetDouseSprite()
        {
            ...
            ButtonSprite = LoadSpriteFromResources("TownOfSushi.Resources.Douse.png", 115f);
            return ButtonSprite;
        }
        public static Sprite ButtonSprite2;
        public static Sprite GetIgniteSprite()
        {
            if (ButtonSprite2 == null) return ButtonSprite2;
            ButtonSprite2 = LoadSpriteFromResources("TownOfSushi.Resources.Ignite.png", 115f);
    ...
    public static class ArsonistHudManagerUpdate
    {
        ...
        public static void Postfix(HudManager __instance)
        {
            ...
            role.IgniteButton.graphic.sprite = Arsonist.GetIgniteSprite();
