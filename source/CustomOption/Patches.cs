    ...
    public static class Patches
    {
        ...
        private class SettingsUpdate
        {
            ...
            public static void Postfix(GameSettingMenu __instance)
            {
                ...
                CreateSettings(__instance, 3, "ModSettings", "Mod Settings", settingsButton, MultiMenu.General);
                ...
                CreateSettings(__instance, 7, "ModifierSettings", "Modifier & Ability Settings", settingsButton, MultiMenu.ModifierAndAbility);
            ...
            public static void ImportSlot(GameSettingMenu __instance, int slotId)
            {
                ...
                try
                {
                    var path = Path.Combine(Application.persistentDataPath, $"GameSettings-Slot{slotId} - TOS");
            ...
            public static void ExportSlot(GameSettingMenu __instance, int slotId)
            {
                ...
                var text = Path.Combine(Application.persistentDataPath, $"GameSettings-Slot{slotId}-temp - TOS");
                try
                {
                    File.WriteAllText(text, builder.ToString());
                    var text2 = Path.Combine(Application.persistentDataPath, $"GameSettings-Slot{slotId} - TOS");
                    File.Delete(text2);
        ...
        class SettingsAwake
        {
            ...
            public static void Postfix(LobbyViewSettingsPane __instance)
            {
                ...
                CreateButton(__instance, 1, "ModTab", "Mod Settings", MultiMenu.General, overview);
                ...
                CreateButton(__instance, 5, "ModifierTab", "Modifier & Ability Settings", MultiMenu.ModifierAndAbility, overview);
            }
