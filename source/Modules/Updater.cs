...
namespace TownOfSushi.Modules
{
    ...
    public class ModUpdaterButton
    {
        ...
        {
            //Check if there's a ToS update
            ModUpdater.LaunchUpdater();

            var data = GetVersioning().FirstOrDefault(x => x.ModVersion.Equals(TownOfSushi.VersionString));
            if (data != null)
            {
        ...
        {
            var text = ModUpdater.Httpclient.GetAsync("https://github.com/itsjesushx/TownOfSushi/raw/master/source/Versioning.json")
    ...
    public class ModUpdater
    {
        ...
        public static void LaunchUpdater()
        {
            ...
            string submergedPath = Uri.UnescapeDataString(uri.Path.Replace("TownOfSushi", "Submerged"));
        ...
        public static async Task<bool> checkForUpdate(string updateType = "TOS")
        {
            ...
            try
            {
                ...
                {
                    PluginSingleton<TownOfSushi>.Instance.Log.LogMessage("Server returned no data: " + response.StatusCode.ToString());
                    return false;
                }
            ...
            {
                PluginSingleton<TownOfSushi>.Instance.Log.LogMessage(ex);
            }
            return false;
        }
        ...
        public static async Task<bool> DownloadUpdate(string updateType = "TOS")
        {
            ...
            try
            {
                ...
                {
                    fullname = fullname.Replace("TownOfSushi", "Submerged"); //TODO A better solution than this to correctly name the dll files
                }
