...
public static class CustomHatManager
{
    ...
    {
        Loader = TownOfSushi.Instance.AddComponent<HatsLoader>();
    }
    ...
    {
        var texture = loadTextureFromDisk(Path.Combine(HatsDirectory, path));
        if (texture == null)
    ...
    public static List<CustomHat> loadHorseHats() {
        ...
        foreach (string resourceName in resourceNames) {
            if (resourceName.Contains("TownOfSushi.Resources.HorseHats.") && resourceName.Contains(".png")) {
