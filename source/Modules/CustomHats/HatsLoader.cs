...
public class HatsLoader : MonoBehaviour
{
    ...
    private IEnumerator CoFetchHats()
    {
        ...
        TownOfSushi.Logger.LogMessage($"Download manifest at: {RepositoryUrl}/{ManifestFileName}");
        ...
        {
            TownOfSushi.Logger.LogError(www.error);
            yield break;
        }
        ...
        TownOfSushi.Logger.LogMessage($"I'll download {toDownload.Count} hat files");
    ...
    private static IEnumerator CoDownloadHatAsset(string fileName)
    {
        ...
        TownOfSushi.Logger.LogMessage($"downloading hat: {fileName}");
        ...
        while (!persistTask.IsCompleted)
        {
            ...
            {
                TownOfSushi.Logger.LogError(persistTask.Exception.Message);
                break;
            }
