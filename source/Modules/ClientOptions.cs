    ...
    public class ClientOptions
    {
        private static readonly SelectionBehaviour[] AllOptions = 
        {
            new()
            {
                ...
                OnClick = () => { return TownOfSushi.DeadSeeGhosts.Value = !TownOfSushi.DeadSeeGhosts.Value; },
                DefaultValue = TownOfSushi.DeadSeeGhosts.Value
            },
            new()
            {
                Title = "Enable Sound Effects",
                OnClick = () => { return TownOfSushi.EnableSoundEffects.Value = !TownOfSushi.EnableSoundEffects.Value; },
                DefaultValue = TownOfSushi.EnableSoundEffects.Value
            },
            new()
            {
                Title = "Disable Lobby Music",
                OnClick = () => { return TownOfSushi.DisableLobbyMusic.Value = !TownOfSushi.DisableLobbyMusic.Value; },
                DefaultValue = TownOfSushi.DisableLobbyMusic.Value
            },
            new()
            {
                Title = "Dead See Roles",
                OnClick = () => { return TownOfSushi.DeadSeeRoles.Value = !TownOfSushi.DeadSeeRoles.Value; },
                DefaultValue = TownOfSushi.DeadSeeRoles.Value
            },
            new()
            {
                Title = "Dead See Tasks",
                OnClick = () => { return TownOfSushi.DeadSeeTasks.Value = !TownOfSushi.DeadSeeTasks.Value; },
                DefaultValue = TownOfSushi.DeadSeeTasks.Value
            },
            new()
            {
