namespace TownOfSushi.Modules
{
    class Colors 
    {
        ...
        public readonly static Color32 Agent = new Color32(0, 0, 255, 255);
        public readonly static Color Phantom = new Color(0.4f, 0.16f, 0.38f, 1f);
        public readonly static Color32 Amnesiac = new Color32(34, 255, 255, 255); 
        public readonly static Color Juggernaut = new Color(0.55f, 0f, 0.3f, 1f);
        public readonly static Color32 GuardianAngel = new Color32(255, 255, 255, 255);
        ...
        public readonly static Color Romantic = new Color(1f, 0.4f, 0.8f, 1f);
