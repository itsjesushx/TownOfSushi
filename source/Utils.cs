    ...
    public static class Utils
    {
        ...
        public static void MurderPlayer(PlayerControl killer, PlayerControl target, bool jumpToBody)
        {
            ...
            if (data != null && !data.IsDead)
            {
                ...
                {
                    var shy = Ability.GetAbility<Chameleon>(killer);
                    shy.Opacity = 1f;
                ...
                if (killer.Is(RoleEnum.Vigilante))
                {
                    ...
                    else if (killer == target) vigilante.Misfire = true;
                }
        ...
        public static void ResetCustomTimers()
        {
            ...
            {
                var veteran = Modifier.GetModifier<Disperser>(PlayerControl.LocalPlayer);
