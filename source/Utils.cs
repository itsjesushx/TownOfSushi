...
namespace TownOfSushi
{
    ...
    public static class Utils
    {
        ...
        public static AudioClip LoadAudioClipFromResources(string path, string clipName = "UNNAMED_TOS_AUDIO_CLIP") 
        {
        ...
        public static bool AbilityUsed(PlayerControl player, PlayerControl target = null)
        {
            ...
            if (PlayerControl.LocalPlayer.Is(RoleEnum.Aurial) && !IsDead())
            {
                var aurial = GetRole<Aurial>(PlayerControl.LocalPlayer);
        ...
        public static class ButtonPositions 
        {
            ...
            public static readonly Vector3 lowerRowFarLeft = new Vector3(-3f, 0f, 0f); // Adjusted to be just below upperRowFarLeft
        ...
        {
            return NormalGameOptionsV09.KillDistances[OptionsManager().currentNormalGameOptions.KillDistance];
        }
        ...
        public static PlayerControl SetTargets(bool onlyCrewmates = false, bool targetPlayersInVents = false, IEnumerable<PlayerControl> untargetablePlayers = null, PlayerControl targetOverride = null)
        {
            ...
            float num = NormalGameOptionsV09.KillDistances[GameOptionsManager.Instance.currentNormalGameOptions.KillDistance];
            var allPlayers = GameData.Instance.AllPlayers;
        ...
        public static void MurderPlayer(PlayerControl killer, PlayerControl target, bool jumpToBody)
        {
            ...
            if (data != null && !data.IsDead)
            {
                ...
                if (target.Is(ModifierEnum.Celebrity))
                {
                    Color color = Color.yellow;
                    if (GetModifier<Celebrity>(target).ShowFactions)
                    {
                        color = Color.white;
